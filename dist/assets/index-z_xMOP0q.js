...
Reply with only the suggestion text, no preamble.`}const Fa=Object.freeze(Object.defineProperty({__proto__:null,buildDistractionPrompt:Na,buildMorningPrompt:Oa,buildWeeklySummaryPrompt:Ra,callGemini:Mt,dayLabel:Ca,esc:j,fmtHours:Be,fmtMins:B,fmtTime:At,hourLabel:Dt,onSwipeLeft:qa,onSwipeRight:Ba,todayStr:F},Symbol.toStringTag,{value:"Module"}));let Oe="all",ge="active",dt="priority",ts=null;async function ur(t){const[e,n]=await Promise.all([te(),oe()]);t.innerHTML=`
  ...
  `;async function s(){const[a,i,r]=await Promise.all([S.tasks.toArray(),te(),oe()]);Ka(a,i,r),za(a)}t.querySelector("#ctx-filters").addEventListener("click",a=>{const i=a.target.closest(".ctx-pill");i&&(Oe=i.dataset.ctx,ts=null,t.querySelectorAll(".ctx-pill").forEach(r=>r.classList.remove("active")),i.classList.add("active"),s())}),t.querySelectorAll(".filter-tab").forEach(a=>{a.addEventListener("click",()=>{ge=a.dataset.filter,t.querySelectorAll(".filter-tab").forEach(i=>i.classList.remove("active")),a.classList.add("active"),s()})}),t.querySelector("#sort-select").addEventListener("change",a=>{dt=a.target.value,s()}),t.querySelector("#add-task-btn").addEventListener("click",()=>{hr(s)}),t.querySelector("#plan-btn").addEventListener("click",()=>{ie(()=>Promise.resolve().then(()=>vn),void 0).then(a=>a.navigateTo("focus"))}),s()}function Ka(t,e,n){const s=document.getElementById("task-list");if(!s)return;let a=Oe==="all"?t:t.filter(l=>l.context===Oe);ts&&(a=a.filter(l=>l.subjectId===ts));const i=a.filter(l=>!l.completedAt),r=a.filter(l=>!!l.completedAt);let o=[];if(ge==="today"?o=i.filter(l=>l.status==="today"):ge==="done"?o=r:o=i,o=pr(o,dt),s.innerHTML="",o.length===0){s.appendChild(mr(ge));return}if(ge==="active"){const l=o.filter(c=>c.status==="today"),d=o.filter(c=>c.status!=="today");l.length>0&&(s.insertAdjacentHTML("beforeend",zs("Today",l.length)),l.forEach(c=>s.appendChild(An(c,e,n)))),d.length>0&&(s.insertAdjacentHTML("beforeend",zs("Backlog",d.length)),d.forEach(c=>s.appendChild(An(c,e,n))))}else o.forEach(l=>s.appendChild(An(l,e,n)))}function pr(t,e){return[...t].sort((n,s)=>{if(e==="due")return!n.dueDate&&!s.dueDate?(n.priority||3)-(s.priority||3):n.dueDate?s.dueDate?new Date(n.dueDate)-new Date(s.dueDate):-1:1;if(e==="created")return(s.createdAt||0)-(n.createdAt||0);const a=(n.priority||3)-(s.priority||3);return a!==0?a:(n.createdAt||0)-(s.createdAt||0)})}function An(t,e,n){const s=e.contexts.find(h=>h.id===t.context),a=t.subjectId?n.find(h=>h.id===t.subjectId):null,i=(s==null?void 0:s.color)||"#888",r=(s==null?void 0:s.label)||t.context,o=!!t.completedAt,d={1:"var(--coral)",2:"var(--amber)",3:"var(--text-muted)"}[t.priority]||"var(--text-muted)",c=document.createElement("div");c.className="task-row-wrap",c.dataset.id=t.id,c.innerHTML=`
  ...
  `}async function Vs(t,e,n,s,a){let i=null;if(a.aiDistractionAlerts&&a.aiApiKey&&P.distractions>0){const r=await $t(F()),o=r.length?r.reduce((l,d)=>l+(d.distractions||0),0)/r.length:0;P.distractions>o*1.5+1&&(i=await Mt(Na(P,o),a.aiApiKey).catch(()=>null))}if(a.aiSmartRescheduling&&a.aiApiKey)try{const r=new Date,o=r.getHours()*60+r.getMinutes(),l=await S.time_blocks.where("date").equals(F()).filter(d=>d.startTime>o).toArray();if(l.length>0&&!i){const d=[...new Set(l.map(h=>h.taskId).filter(Boolean))],u=(await Promise.all(d.map(h=>S.tasks.get(h)))).filter(Boolean).map(h=>h.title),p=`You are a productivity assistant. A focus session just ended and it's now ${r.getHours()}:${String(r.getMinutes()).padStart(2,"0")}. The user still has these tasks planned: ${u.join(", ")}. In one short sentence (under 15 words), suggest whether to continue the plan or drop the lowest priority task. Be direct.`;i=await Mt(p,a.aiApiKey).catch(()=>null)}}catch{}kr(t,e,n,s,a,i)}function kr(t,e,n,s,a,i=null){Lt("Done","done");const r=t.querySelector("#session-stage"),o=P.distractions>0?Math.max(0,Math.round(100-P.distractions/P.durationMins*100*.5)):100;r.innerHTML=`
    <div class="wrap-hero">
      <div class="wrap-icon">
  ...
  `,Zt=setInterval(()=>{var d;a--;const o=document.getElementById("break-num"),l=document.getElementById("break-ring");o&&(o.textContent=At(Math.max(0,a))),l&&l.setAttribute("stroke-dashoffset",(i*(1-a/s)).toFixed(1)),a<=0&&(Re(),n.breakEndReminder&&((d=window._apexPlayBeep)==null||d.call(window,"break-end")),Ws(t,n))},1e3),r.querySelector("#skip-break").addEventListener("click",()=>{Re(),Ws(t,n)})}async function Ws(t,e){const[n,s]=await Promise.all([Ms(),oe()]);fn(t,n,e,s)}async function Sr(t,e,n,s){const a=await S.time_blocks.where("date").equals(F()).toArray(),i=Object.fromEntries(e.map(o=>[o.id,o])),r=t.querySelector("#session-stage");r.innerHTML=`
  ...
  `,r.querySelector("#back-setup").addEventListener("click",async()=>{fn(t,e,n,s)}),r.querySelector("#planner-start").addEventListener("click",async()=>{const o=new Date,l=o.getHours()*60+o.getMinutes(),d=a.filter(h=>h.taskId&&i[h.taskId]).sort((h,v)=>h.startTime-v.startTime).find(h=>h.startTime>=l),c=d?i[d.taskId]:e[0];if(!c)return;const u=n.contexts.find(h=>h.id===c.context),p=c.subjectId?s.find(h=>h.id===c.subjectId):null;mn(t,c,u,p,(d==null?void 0:d.durationMins)||n.defaultDuration,n)}),as(r,e,n,s,a,i)}function as(t,e,n,s,a,i){const r=t.querySelector("#planner-grid");if(!r)return;r.innerHTML="";const o=Array.from({length:14},(c,u)=>u+7),d=new Date().getHours();o.forEach(c=>{const u=a.find(k=>Math.floor(k.startTime/60)===c),p=u?i[u.taskId]:null,h=p?n.contexts.find(k=>k.id===p.context):null,v=p!=null&&p.subjectId?s.find(k=>k.id===p.subjectId):null,f=(v==null?void 0:v.color)||(h==null?void 0:h.color)||"#7F77DD",g=c===d,y=document.createElement("div");y.className="planner-row"+(g?" planner-now":""),y.innerHTML=`
      <div class="planner-hour ${g?"planner-hour--now":""}">${Va(c)}</div>
    ...
    `;const m=y.querySelector(".planner-block");if(m){let k=null;m.addEventListener("click",async()=>{if(k){clearTimeout(k),k=null;return}const x=await S.tasks.get(+m.dataset.taskId),M=await te(),_=M.contexts.find(L=>L.id===(x==null?void 0:x.context)),T=x!=null&&x.subjectId?s.find(L=>L.id===x.subjectId):null;mn(Ds,x,_,T,u.durationMins||M.defaultDuration,M)});const $=()=>{k=setTimeout(async()=>{if(k=null,!confirm("Remove this block?"))return;await S.time_blocks.delete(u.id);const x=await S.time_blocks.where("date").equals(F()).toArray();as(t,e,n,s,x,Object.fromEntries(e.map(_=>[_.id,_])));const M=t.querySelector("#planner-total");M&&(M.textContent=is(x)+"h blocked")},500)},w=()=>{k&&(clearTimeout(k),k=null)};m.addEventListener("touchstart",$,{passive:!0}),m.addEventListener("touchend",w),m.addEventListener("mousedown",$),m.addEventListener("mouseup",w),m.addEventListener("mouseleave",w)}const b=y.querySelector(".planner-empty");b&&b.addEventListener("click",()=>_r(c,e,n,async()=>{const k=await S.time_blocks.where("date").equals(F()).toArray();as(t,e,n,s,k,Object.fromEntries(e.map(w=>[w.id,w])));const $=t.querySelector("#planner-total");$&&($.textContent=is(k)+"h blocked")})),r.appendChild(y)})}async function _r(t,e,n,s){var l;const a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
    <div class="modal-card detail-modal">
      <div class="modal-drag-bar"></div>
      <div class="modal-header">
        <p style="font-size:15px;font-weight:500;color:var(--text-primary);margin:0">Block ${Va(t)}</p>
  ...
  `}function is(t){return(t.reduce((e,n)=>e+(n.durationMins||50),0)/60).toFixed(1)}function Va(t){return t===0?"12am":t<12?`${t}am`:t===12?"12pm":`${t-12}pm`}async function $r(t){const e=new Date;let n=e.getFullYear(),s=e.getMonth();t.innerHTML=`
    <div class="view-header">
  ...
  `}async function Wa(t,e,n,s){const a=document.getElementById("cal-nav"),i=document.getElementById("cal-grid");if(!a||!i)return;const r=new Date(t,e,1).toLocaleDateString("en-GB",{month:"long",year:"numeric"});a.innerHTML=`
  ...
  `;const o=new Date(t,e,1),l=new Date(t,e+1,0),d=$e(o),c=$e(l),[u,p,h]=await Promise.all([Ke(d,c),ws(d,c),S.tasks.where("dueDate").between(d,c,!0,!0).toArray()]),v=new Map,f=w=>(v.has(w)||v.set(w,{sessions:[],planned:[],tasks:[]}),v.get(w));u.forEach(w=>f(w.date).sessions.push(w)),p.forEach(w=>f(w.date).planned.push(w)),h.forEach(w=>{w.dueDate&&f(w.dueDate).tasks.push(w)});const g=(o.getDay()+6)%7,y=l.getDate(),m=new Date,b=$e(m);let $=`<div class="cal-dow-row">${["Mon","Tue","Wed","Thu","Fri","Sat","Sun"].map(w=>`<div class="cal-dow">${w}</div>`).join("")}</div><div class="cal-cells">`;for(let w=0;w<g;w++)$+='<div class="cal-day cal-day--empty"></div>';for(let w=1;w<=y;w++){const x=new Date(t,e,w),M=$e(x),_=v.get(M)||{sessions:[],planned:[],tasks:[]},T=M===b,L=x<m&&!T,H=x>m,K=[...new Set(_.sessions.filter(V=>V.subjectId).map(V=>{const Z=n.find(U=>U.id===V.subjectId);return Z==null?void 0:Z.color}).filter(Boolean))].slice(0,3),C=_.sessions.reduce((V,Z)=>V+(Z.durationMins||0),0);$+=`
  ...
  `,requestAnimationFrame(()=>{var f;(f=s.querySelector("#day-sheet-inner"))==null||f.classList.add("day-sheet--open")}),(h=s.querySelector("#day-sheet-close"))==null||h.addEventListener("click",()=>{var f;(f=s.querySelector("#day-sheet-inner"))==null||f.classList.remove("day-sheet--open"),setTimeout(()=>{s.innerHTML=""},280)}),s.addEventListener("click",f=>{var g;f.target===s&&((g=s.querySelector("#day-sheet-inner"))==null||g.classList.remove("day-sheet--open"),setTimeout(()=>{s.innerHTML=""},280))}),s.querySelectorAll(".day-session-delete").forEach(f=>{f.addEventListener("click",async g=>{g.stopPropagation();const y=+f.dataset.id;if(await Zi(y),s.innerHTML="",await rs(t,e),document.getElementById("cal-grid")){const b=document.getElementById("cal-nav"),k=b?parseInt(b.dataset.month??new Date().getMonth()):new Date().getMonth(),$=b?parseInt(b.dataset.year??new Date().getFullYear()):new Date().getFullYear();await Wa($,k,e)}})}),(v=s.querySelector("#day-schedule-btn"))==null||v.addEventListener("click",()=>{var f;(f=s.querySelector("#day-sheet-inner"))==null||f.classList.remove("day-sheet--open"),setTimeout(()=>{s.innerHTML="",Ya(t,e,async()=>{const[g,y,m]=await Promise.all([te(),oe()]);await rs(t,y)})},280)})}function Ya(t,e,n){var l,d;const s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
    <div class="modal-card detail-modal">
      <div class="modal-drag-bar"></div>
      <div class="modal-header">
  ...
  `;let s="week";async function a(){Kr(),t.querySelector("#btn-week").classList.toggle("seg-active",s==="week"),t.querySelector("#btn-day").classList.toggle("seg-active",s==="day"),s==="week"?await Dr(e,n):await Mr(e,n)}t.querySelector("#btn-week").addEventListener("click",()=>{s="week",a()}),t.querySelector("#btn-day").addEventListener("click",()=>{s="day",a()}),t.querySelector("#open-review").addEventListener("click",()=>{ie(()=>Promise.resolve().then(()=>vn),void 0).then(i=>i.navigateTo("review"))}),a()}async function Dr(t,e){const{fromStr:n,toStr:s,monday:a,prevFromStr:i,prevToStr:r}=Fr();document.getElementById("period-label").textContent="Week of "+a.toLocaleDateString("en-GB",{day:"numeric",month:"short"});const[o,l,d,c]=await Promise.all([Ke(n,s),Ke(i,r),Aa(t.activeDays,t.dailyGoalHours*60,t.streakFreezeEnabled?t.streakGraceDays??1:0),S.focus_sessions.toArray()]),u=o.reduce((A,O)=>A+(O.durationMins||0),0),p=l.reduce((A,O)=>A+(O.durationMins||0),0),h=o.filter(A=>A.durationMins>0).map(A=>Math.max(0,100-Math.round((A.distractions||0)/A.durationMins*100*.5))),v=h.length?Math.round(h.reduce((A,O)=>A+O,0)/h.length):null,f=l.filter(A=>A.durationMins>0).map(A=>Math.max(0,100-Math.round((A.distractions||0)/A.durationMins*100*.5))),g=f.length?Math.round(f.reduce((A,O)=>A+O,0)/f.length):null,y=c.length?c.reduce((A,O)=>(O.durationMins||0)>(A.durationMins||0)?O:A,c[0]):null,m=y&&o.some(A=>A.id===y.id),b=p>0?Math.round((u-p)/p*100):null,k=l.length>0?o.length-l.length:null,$=Array(24).fill(0);o.forEach(A=>{$[new Date(A.startedAt).getHours()]+=A.durationMins||0});const w=$.indexOf(Math.max(...$.slice(6,22))),x=$[w]>0?Dt(w):"—",M=Array(24).fill(0);l.forEach(A=>{M[new Date(A.startedAt).getHours()]+=A.durationMins||0});const _=M.indexOf(Math.max(...M.slice(6,22))),T=Array(7).fill(0);o.forEach(A=>{const O=(new Date(A.startedAt).getDay()+6)%7;T[O]+=A.durationMins||0});const L=new Map;o.forEach(A=>{A.subjectId&&L.set(A.subjectId,(L.get(A.subjectId)||0)+(A.durationMins||0))});const H=new Map;l.forEach(A=>{A.subjectId&&H.set(A.subjectId,(H.get(A.subjectId)||0)+(A.durationMins||0))});const K={};o.forEach(A=>{const O=A.context||"other";K[O]=(K[O]||0)+(A.durationMins||0)});const C=Math.max(1,Object.values(K).reduce((A,O)=>A+O,0)),V=t.streakFreezeEnabled?t.streakGraceDays??1:0,Z=await Promise.all(e.map(async A=>{const{current:O,best:at}=await bs(A.id,A.dailyGoalMins,t.activeDays,V);return{...A,current:O,best:at}})),U=document.getElementById("insights-body");U.innerHTML=`
    ...
    <div class="card" style="margin-top:12px">
      ...
      <p class="metric-helper" style="margin-bottom:8px">
        ${$[w]>0?`Most productive at ${x}${_&&_!==w?` — shifted from ${Dt(_)} last week`:""}`:"No sessions yet this week"}
      </p>
  ...
  `,i.length>0&&(Br(i,e),Or(i,t.contexts),Rr(i)),e.length>0&&f.size>0&&Tr(e,f)}function Ir(t,e){const n=document.getElementById("daily-chart");if(!n)return;const s=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],a=e.dailyGoalHours,i=t.map((o,l)=>o/60>=a?"#1D9E75":o>0?"#7F77DD":"rgba(127,119,221,0.15)"),r=new Chart(n,{type:"bar",data:{labels:s,datasets:[{data:t.map(o=>+(o/60).toFixed(2)),backgroundColor:i,borderRadius:5,borderSkipped:!1},{type:"line",data:Array(7).fill(a),borderColor:"rgba(127,119,221,0.35)",borderDash:[4,4],borderWidth:1,pointRadius:0,fill:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:o=>o.datasetIndex===0?B(Math.round(o.parsed.y*60)):"Goal: "+o.parsed.y+"h"}}},scales:{x:{grid:{display:!1},ticks:{color:"#5e5a72",font:{size:11}}},y:{grid:{color:"rgba(255,255,255,0.05)"},ticks:{color:"#5e5a72",font:{size:11},callback:o=>o+"h"},beginAtZero:!0}}}});jt.push(r)}function Lr(t,e,n,s){const a=document.getElementById("subj-bars");if(!a)return;const i=Math.max(1,s),r=t.filter(o=>e.has(o.id)).sort((o,l)=>(e.get(l.id)||0)-(e.get(o.id)||0));if(r.length===0){a.innerHTML='<p class="empty-hint">No subject sessions this week.</p>';return}a.innerHTML=r.map(o=>{const l=e.get(o.id)||0,d=n.get(o.id)||0,c=Math.round(l/i*100);Math.min(100,Math.round(l/(o.dailyGoalMins*5)*100));const u=d>0?Math.round((l-d)/d*100):null;return`
    ...
    `}).join("")}function jr(t){const e=document.getElementById("streak-panel");if(!e)return;const n=t.filter(s=>s.current>0||s.best>0);if(n.length===0){e.innerHTML='<p class="empty-hint">Hit your daily goal for a subject to start a streak.</p>';return}e.innerHTML=n.map(s=>`
  ...
  `).join("")}function Tr(t,e){const n=document.getElementById("today-subj-bars");n&&(n.innerHTML=t.filter(s=>e.has(s.id)).map(s=>{const a=e.get(s.id)||0,i=Math.min(100,Math.round(a/s.dailyGoalMins*100));return`
    ...
    `}).join(""))}function Pr(t){const e=document.getElementById("quality-chart");if(!e)return;const n={Deep:0,Good:0,Patchy:0};if(t.forEach(r=>{r.qualityRating&&n[r.qualityRating]++}),Object.values(n).reduce((r,o)=>r+o,0)===0){e.parentElement.innerHTML='<p class="empty-hint" style="padding:16px 0;font-size:11px">Rate sessions to see quality data.</p>';return}const a=new Chart(e,{type:"doughnut",data:{labels:["Deep","Good","Patchy"],datasets:[{data:[n.Deep,n.Good,n.Patchy],backgroundColor:["#1D9E75","#7F77DD","#D85A30"],borderWidth:0,hoverOffset:4}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"68%",plugins:{legend:{display:!1},tooltip:{callbacks:{label:r=>`${r.label}: ${r.parsed}`}}}}});jt.push(a);const i=document.createElement("div");i.className="quality-legend",i.innerHTML=[["Deep","#1D9E75",n.Deep],["Good","#7F77DD",n.Good],["Patchy","#D85A30",n.Patchy]].filter(([,,r])=>r>0).map(([r,o,l])=>`<span class="q-leg-item"><span style="width:8px;height:8px;border-radius:2px;background:${o};display:inline-block"></span> ${r} <strong>${l}</strong></span>`).join(""),e.parentElement.appendChild(i)}function Cr(t){const e=document.getElementById("heatmap");if(!e)return;const n=Math.max(...t.slice(6,22),1);for(let s=6;s<=21;s++){const a=t[s],i=a===0?.07:.14+a/n*.82,r=Math.max(8,Math.round(a/n*60)+8),o=document.createElement("div");o.className="heat-cell",o.style.cssText=`height:${r}px;opacity:${i.toFixed(2)};background:var(--accent)`,o.title=`${Dt(s)} — ${B(Math.round(a))}`,e.appendChild(o)}}function qr(t,e,n){const s=document.getElementById("goal-bars");if(s){if(Object.keys(t).length===0){s.innerHTML='<p class="empty-hint">No sessions yet.</p>';return}s.innerHTML=Object.entries(t).sort((a,i)=>i[1]-a[1]).map(([a,i])=>{const r=n.find(c=>c.id===a),o=(r==null?void 0:r.color)||"#888780",l=(r==null?void 0:r.label)||a,d=Math.round(i/e*100);return`
  ...
  `).join("")}function Fr(){const t=new Date,e=new Date(t);e.setDate(t.getDate()-(t.getDay()+6)%7);const n=new Date(e);n.setDate(e.getDate()-7);const s=new Date(e);return s.setDate(e.getDate()-1),{fromStr:e.toISOString().slice(0,10),toStr:t.toISOString().slice(0,10),prevFromStr:n.toISOString().slice(0,10),prevToStr:s.toISOString().slice(0,10),monday:e}}function Ee(t,e,n="",s=""){return`
    ...
    </div>`}function Kr(){jt.forEach(t=>{try{t.destroy()}catch{}}),jt=[]}async function Hr(t){const e=await te();let n=structuredClone(e),s="session";t.innerHTML=`
    <div class="view-header">
    ...
    <div class="settings-layout">
      <nav class="settings-nav" id="settings-nav">
        ${Le("session","Session",Xr())}
        ${Le("subjects","Subjects",Zr())}
        ${Le("recurring","Recurring",ao())}
        ${Le("contexts","Contexts",eo())}
        ${Le("alerts","Alerts",to())}
        ${Le("sync","Sync",no())}
        ${Le("ai","AI",so())}
      </nav>
  ...
  `;async function a(){var o;const i=t.querySelector("#settings-content"),r={session:Gr,subjects:Ur,contexts:Wr,alerts:Yr,sync:Jr,ai:Qr};await((o=r[s])==null?void 0:o.call(r,i,n))}t.querySelector("#settings-nav").addEventListener("click",async i=>{const r=i.target.closest(".settings-nav-item");r&&(t.querySelectorAll(".settings-nav-item").forEach(o=>o.classList.remove("active")),r.classList.add("active"),s=r.dataset.panel,await a())}),t.querySelector("#save-btn").addEventListener("click",async()=>{await Wi(n);const i=t.querySelector("#save-btn");i.textContent="Saved ✓",i.style.background="var(--teal)",setTimeout(()=>{i.textContent="Save",i.style.background=""},2e3)}),await a()}function Gr(t,e){var n;t.innerHTML=`
  ...
  `,gn(t,e)}function Jr(t,e){const n=window._apexSyncStatus||{status:"idle",pending:0},s={idle:{text:"Not started yet",cls:""},syncing:{text:"Syncing…",cls:"sync-badge--syncing"},synced:{text:"Synced just now",cls:"sync-badge--ok"},offline:{text:`Offline — ${n.pending} change${n.pending!==1?"s":""} pending`,cls:"sync-badge--offline"},error:{text:`Sync error — ${n.pending} queued`,cls:"sync-badge--error"}},a=s[n.status]||s.idle;t.innerHTML=`
    <div class="settings-section">
  ...
  `,gn(t,e),ie(()=>Promise.resolve().then(()=>ze),void 0).then(async({getLastSyncTime:i})=>{const r=await i(),o=t.querySelector("#last-sync-time");o&&(o.textContent=r?new Date(r).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",day:"numeric",month:"short"}):"Never")}).catch(()=>{})}function Qr(t,e){t.innerHTML=`
    <div class="settings-section">
  ...
  `,gn(t,e),t.querySelectorAll("#prov-gemini, #prov-openai").forEach(n=>{n.addEventListener("click",()=>{t.querySelectorAll("#prov-gemini, #prov-openai").forEach(s=>s.classList.remove("seg-active")),n.classList.add("seg-active"),e.aiProvider=n.dataset.val})}),t.querySelector("#test-key").addEventListener("click",async()=>{const n=t.querySelector("#key-status");if(!e.aiApiKey){n.textContent="No API key set.",n.className="key-status fail";return}n.textContent="Testing…",n.className="key-status";const{callGemini:s}=await ie(async()=>{const{callGemini:i}=await Promise.resolve().then(()=>Fa);return{callGemini:i}},void 0),a=await s('Reply with only the word "ok".',e.aiApiKey);a&&a.toLowerCase().includes("ok")?(n.textContent="Connected ✓",n.className="key-status ok"):(n.textContent="Connection failed. Check your key.",n.className="key-status fail")})}function Ja(t){const e=window.matchMedia("(prefers-color-scheme: dark)").matches,n=t==="dark"||t==="system"&&e;document.documentElement.setAttribute("data-theme",n?"dark":"light")}function gn(t,e){t.querySelectorAll("[data-field]").forEach(n=>{const s=n.dataset.field;n.type==="checkbox"?n.addEventListener("change",()=>{e[s]=n.checked}):n.type==="number"?n.addEventListener("input",()=>{e[s]=+n.value}):n.addEventListener("input",()=>{e[s]=n.value})})}function J(t,e,n,s=""){return`
    ...
    <button class="settings-nav-item ${t==="session"?"active":""}" data-panel="${t}">
      ${n}<span>${e}</span>
    </button>`}const Ue=t=>`<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">${t}</svg>`,Xr=()=>Ue('<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>'),Zr=()=>Ue('<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>'),eo=()=>Ue('<circle cx="6" cy="6" r="2"/><circle cx="14" cy="10" r="2"/><path d="M8 6h4M8 10H4"/>'),to=()=>Ue('<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>'),no=()=>Ue('<path d="M21 2v6h-6"/><path d="M3 12a9 9 0 0 1 15-6.7L21 8"/><path d="M3 22v-6h6"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16"/>'),so=()=>Ue('<rect x="2" y="4" width="20" height="16" rx="2"/><path d="M8 10h.01M12 10h.01M16 10h.01M8 14h8"/>'),ao=()=>Ue('<path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/>');async function io(t){const e=await te(),{fromStr:n,toStr:s,monday:a,sunday:i}=Is(),r=await Ke(n,s),o=r.reduce((g,y)=>g+(y.durationMins||0),0),l=await Aa(e.activeDays,e.dailyGoalHours*60),d=await S.tasks.filter(g=>g.completedAt&&g.completedAt>=a.getTime()&&g.completedAt<=Date.now()).toArray(),c=await S.tasks.where("status").equals("today").filter(g=>!g.completedAt).toArray(),u={};r.forEach(g=>{u[g.context]=(u[g.context]||0)+(g.durationMins||0)});const p=Object.entries(u).sort((g,y)=>y[1]-g[1])[0],h=p?e.contexts.find(g=>g.id===p[0]):null,v=Array(7).fill(0);r.forEach(g=>{const y=(new Date(g.startedAt).getDay()+6)%7;v[y]+=g.durationMins||0});const f=Math.max(...v,1);t.innerHTML=`
    <div class="view-header">
      <div>
    ...
    <div class="card">
      ...
      <textarea class="session-note" id="review-note" rows="4"
        placeholder="What went well? What would you do differently next week?">${await oo()}</textarea>
    ...
    <div class="review-next-week">
      ...
      <textarea class="session-note" id="intention-note" rows="2" style="margin-top:8px"
        placeholder="What's the #1 thing to move forward on next week?">${await lo()}</textarea>
      <button class="btn-primary full-width" style="margin-top:10px" id="save-intention-btn">Set intention</button>
    </div>
  `,t.querySelector("#close-review").addEventListener("click",()=>{ie(()=>Promise.resolve().then(()=>vn),void 0).then(g=>g.navigateTo("inbox"))}),t.querySelector("#save-note-btn").addEventListener("click",async()=>{const g=t.querySelector("#review-note").value;await S.settings.put({key:"reviewNote_"+n,value:g});const y=t.querySelector("#save-note-btn");y.textContent="Saved ✓",setTimeout(()=>{y.textContent="Save reflection"},1800)}),t.querySelector("#save-intention-btn").addEventListener("click",async()=>{const g=t.querySelector("#intention-note").value;await S.settings.put({key:"intention_"+s,value:g});const y=t.querySelector("#save-intention-btn");y.textContent="Intention set ✓",setTimeout(()=>{y.textContent="Set intention"},1800)}),t.querySelectorAll(".intention-btn").forEach(g=>{g.addEventListener("click",()=>{g.classList.toggle("seg-active")})}),e.aiApiKey&&e.aiWeeklyReview&&r.length>0?ro(r,o,l,e):e.aiApiKey?r.length===0&&(document.getElementById("ai-review-body").innerHTML='<p class="empty-hint">Complete sessions this week to generate a review.</p>'):document.getElementById("ai-review-body").innerHTML='<p class="empty-hint">Add a Gemini API key in Settings → AI to enable AI weekly reviews.</p>'}async function ro(t,e,n,s){const a=document.getElementById("ai-review-body");if(!a)return;const{callGemini:i}=await ie(async()=>{const{callGemini:c}=await Promise.resolve().then(()=>Fa);return{callGemini:c}},void 0),r=t.reduce((c,u)=>c+(u.distractions||0),0)/t.length,o=`You are a productivity coach giving a warm, direct weekly review.
...
Reply with only valid JSON, no markdown.`,l=await i(o,s.aiApiKey);if(!a)return;if(!l){a.innerHTML='<p class="empty-hint">AI review unavailable. Check your API key.</p>';return}let d={};try{const c=l.replace(/```json|```/g,"").trim();d=JSON.parse(c)}catch{a.innerHTML=`<p style="font-size:13px;color:var(--text-secondary);line-height:1.6">${j(l)}</p>`;return}a.innerHTML=`
  ...
  `}function Dn(t,e,n){return e?`
    ...
    </div>`:""}async function oo(){const{fromStr:t}=Is(),e=await S.settings.get("reviewNote_"+t);return j((e==null?void 0:e.value)||"")}async function lo(){const{toStr:t}=Is(),e=await S.settings.get("intention_"+t);return j((e==null?void 0:e.value)||"")}function Is(){const t=new Date,e=new Date(t);e.setDate(t.getDate()-(t.getDay()+6)%7),e.setHours(0,0,0,0);const n=new Date(e);return n.setDate(e.getDate()+6),n.setHours(23,59,59,999),{fromStr:e.toISOString().slice(0,10),toStr:t.toISOString().slice(0,10),monday:e,sunday:n}}const Qa=["inbox","focus","calendar","insights","settings","review"];let un="inbox";const Mn={inbox:ur,focus:vr,calendar:$r,insights:Ar,settings:Hr,review:io};function Xa(){const t=location.hash.replace("#","");Qa.includes(t)&&(un=t),co(),qt(un)}async function qt(t){var n;if(!Qa.includes(t))return;un=t,location.hash=t,document.querySelectorAll(".nav-item").forEach(s=>{s.classList.toggle("active",s.dataset.tab===t)});const e=document.getElementById("view");if(e){e.classList.add("view-exit"),await new Promise(s=>setTimeout(s,120)),e.innerHTML="",e.classList.remove("view-exit"),e.classList.add("view-enter");try{await((n=Mn[t])==null?void 0:n.call(Mn,e)),requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.classList.add("view-enter-active"),setTimeout(()=>{e.classList.remove("view-enter","view-enter-active")},220)})})}catch(s){console.error(`[Apex Focus] Render error on ${t}:`,s),e.innerHTML=`
    ...
    `}}}function co(){document.getElementById("app").innerHTML=`
    <div id="view" class="view"></div>
    <nav class="bottom-nav">
      ${ot("inbox",uo(),"Inbox")}
      ${ot("focus",po(),"Focus")}
      ${ot("calendar",ho(),"Calendar")}
      ${ot("insights",yo(),"Insights")}
      ${ot("settings",fo(),"Settings")}
    </nav>
  `,document.querySelectorAll(".nav-item").forEach(t=>{t.addEventListener("click",()=>qt(t.dataset.tab))})}function ot(t,e,n){return`
    <button class="nav-item ${t===un?"active":""}" data-tab="${t}">
      ${e}<span>${n}</span>
    </button>`}const uo=()=>'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-6l-2 3H10L8 12H2"/><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></svg>',po=()=>'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',ho=()=>'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>',yo=()=>'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>',fo=()=>'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>',vn=Object.freeze(Object.defineProperty({__proto__:null,initRouter:Xa,navigateTo:qt},Symbol.toStringTag,{value:"Module"}));async function mo(){return"Notification"in window?Notification.permission==="granted"?!0:await Notification.requestPermission()==="granted":!1}function Za(t,e,n="apex-focus"){Notification.permission==="granted"&&new Notification(t,{body:e,tag:n,icon:"/icons/icon-192.png",badge:"/icons/icon-192.png",silent:!1})}function go(t="session-end"){try{const e=new(window.AudioContext||window.webkitAudioContext),n={"session-end":[{freq:523,start:0,dur:.12},{freq:659,start:.14,dur:.12},{freq:784,start:.28,dur:.22}],"break-end":[{freq:440,start:0,dur:.1},{freq:440,start:.14,dur:.1}],"goal-reached":[{freq:523,start:0,dur:.1},{freq:659,start:.12,dur:.1},{freq:784,start:.24,dur:.1},{freq:1047,start:.36,dur:.22}]};(n[t]||n["session-end"]).forEach(({freq:a,start:i,dur:r})=>{const o=e.createOscillator(),l=e.createGain();o.connect(l),l.connect(e.destination),o.frequency.value=a,o.type="sine",l.gain.setValueAtTime(.18,e.currentTime+i),l.gain.exponentialRampToValueAtTime(.001,e.currentTime+i+r),o.start(e.currentTime+i),o.stop(e.currentTime+i+r+.05)})}catch{}}function vo(t){if(!t)return;const[e,n]=t.split(":").map(Number),s=new Date,a=new Date;a.setHours(e,n,0,0),a<=s&&a.setDate(a.getDate()+1);const i=a-s;setTimeout(()=>{Za("Plan your day — Apex Focus","Good morning! Time to set your focus blocks for today.")},Math.min(i,2147483647))}te().then(t=>{if(t!=null&&t.theme){Ja(t.theme);try{localStorage.setItem("apexThemeCache",JSON.stringify({theme:t.theme}))}catch{}}});function bo(t="light"){var e;if((e=window.navigator)!=null&&e.vibrate){const n={light:[8],medium:[15],heavy:[30],success:[10,50,10]};navigator.vibrate(n[t]||n.light)}}document.addEventListener("pointerdown",t=>{const e=t.target.closest("button, .task-row, .picker-row, .cal-day, .subject-chip, .ctx-pill");e&&(e.classList.add("haptic-pop"),e.addEventListener("animationend",()=>e.classList.remove("haptic-pop"),{once:!0}))},{passive:!0});window._apexHaptic=bo;window._apexSyncStatus={status:"idle",pending:0,lastSync:null};La((t,e)=>{window._apexSyncStatus={status:t,pending:e,lastSync:window._apexSyncStatus.lastSync};const n=document.getElementById("sync-status-badge");n&&ei(n,t,e)});function ei(t,e,n){const s={idle:{text:"Not started",cls:""},syncing:{text:"Syncing…",cls:"sync-badge--syncing"},synced:{text:"Synced just now",cls:"sync-badge--ok"},offline:{text:`Offline — ${n} change${n!==1?"s":""} pending`,cls:"sync-badge--offline"},error:{text:`Error — ${n} change${n!==1?"s":""} queued`,cls:"sync-badge--error"}},a=s[e]||s.idle;t.textContent=a.text,t.className="sync-status-badge "+a.cls}window._apexUpdateSyncBadge=ei;function wo(t){return new Promise((e,n)=>{if(window.Chart){e();return}const s=document.createElement("script");s.src=t,s.onload=e,s.onerror=n,document.head.appendChild(s)})}let ut=null;window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),ut=t,ko()});function ko(){if(sessionStorage.getItem("installDismissed")||window.matchMedia("(display-mode: standalone)").matches)return;const t=document.createElement("div");t.className="install-banner",t.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("install-btn").addEventListener("click",async()=>{if(!ut)return;ut.prompt();const{outcome:e}=await ut.userChoice;ut=null,t.remove()}),document.getElementById("install-dismiss").addEventListener("click",()=>{sessionStorage.setItem("installDismissed","1"),t.remove()})}async function xo(t){if(!t.aiMorningPrioritisation||!t.aiApiKey)return;const e=await S.settings.get("morningPromptDate");if((e==null?void 0:e.value)===F())return;const s=new Date().getHours();if(s<6||s>11)return;const a=await S.tasks.where("status").anyOf(["today","inbox"]).filter(c=>!c.completedAt).toArray();if(a.length===0)return;const{fromStr:i}=Eo(),r=await Ke(i,F()),o=Oa(a,r),l=await Mt(o,t.aiApiKey);if(!l)return;let d=[];try{const c=l.replace(/```json|```/g,"").trim();d=JSON.parse(c)}catch{return}if(!(!Array.isArray(d)||d.length===0)){for(const c of d){const u=a.find(p=>p.title.toLowerCase().includes(c.toLowerCase().slice(0,20)));u&&u.status!=="today"&&await S.tasks.update(u.id,{status:"today"})}await S.settings.put({key:"morningPromptDate",value:F()}),await S.settings.put({key:"morningPromptResult",value:JSON.stringify(d)}),So(d)}}function So(t){const e=document.createElement("div");e.className="morning-card",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("morning-close").addEventListener("click",()=>e.remove()),document.getElementById("morning-start").addEventListener("click",()=>{e.remove(),qt("focus")}),setTimeout(()=>e.classList.add("morning-card--in"),50)}async function _o(){await wo("https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.1/chart.umd.js"),await S.open(),Xa(),Ta().catch(()=>{}),Pa();const t=await te();t.accentColor&&document.documentElement.style.setProperty("--accent",t.accentColor);try{const n=new Date;n.setDate(n.getDate()-1);const s=n.toISOString().slice(0,10);await S.time_blocks.where("date").below(s).delete()}catch{}if(t.morningReminderEnabled&&await mo()&&vo(t.morningReminderTime),window._apexPlayBeep=go,window._apexNotify=Za,xo(t).catch(()=>{}),new Date().getDay()===0){const n=await S.settings.get("lastReviewDate");(n==null?void 0:n.value)!==F()&&setTimeout(()=>$o(),3e3)}}function $o(){const t=document.createElement("div");t.className="morning-card",t.innerHTML=`
    <div class="morning-card-inner">
      <div class="morning-header">
