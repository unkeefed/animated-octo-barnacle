(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();const ni="modulepreload",si=function(t){return"/"+t},js={},ie=function(e,n,s){let a=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),o=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));a=Promise.allSettled(n.map(l=>{if(l=si(l),l in js)return;js[l]=!0;const d=l.endsWith(".css"),c=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":ni,d||(u.as="script"),u.crossOrigin="",u.href=l,o&&u.setAttribute("nonce",o),document.head.appendChild(u),d)return new Promise((p,h)=>{u.addEventListener("load",p),u.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(r){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=r,window.dispatchEvent(o),!o.defaultPrevented)throw r}return a.then(r=>{for(const o of r||[])o.status==="rejected"&&i(o.reason);return e().catch(i)})},R=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,G=Object.keys,Y=Array.isArray;function X(t,e){return typeof e!="object"||G(e).forEach(function(n){t[n]=e[n]}),t}typeof Promise>"u"||R.Promise||(R.Promise=Promise);const bt=Object.getPrototypeOf,ai={}.hasOwnProperty;function ae(t,e){return ai.call(t,e)}function et(t,e){typeof e=="function"&&(e=e(bt(t))),(typeof Reflect>"u"?G:Reflect.ownKeys)(e).forEach(n=>{be(t,n,e[n])})}const Qs=Object.defineProperty;function be(t,e,n,s){Qs(t,e,X(n&&ae(n,"get")&&typeof n.get=="function"?{get:n.get,set:n.set,configurable:!0}:{value:n,configurable:!0,writable:!0},s))}function Je(t){return{from:function(e){return t.prototype=Object.create(e.prototype),be(t.prototype,"constructor",t),{extend:et.bind(null,t.prototype)}}}}const ii=Object.getOwnPropertyDescriptor;function os(t,e){let n;return ii(t,e)||(n=bt(t))&&os(n,e)}const ri=[].slice;function en(t,e,n){return ri.call(t,e,n)}function Xs(t,e){return e(t)}function ct(t){if(!t)throw new Error("Assertion Failed")}function Zs(t){R.setImmediate?setImmediate(t):setTimeout(t,0)}function ea(t,e){return t.reduce((n,s,a)=>{var i=e(s,a);return i&&(n[i[0]]=i[1]),n},{})}function we(t,e){if(typeof e=="string"&&ae(t,e))return t[e];if(!e)return t;if(typeof e!="string"){for(var n=[],s=0,a=e.length;s<a;++s){var i=we(t,e[s]);n.push(i)}return n}var r=e.indexOf(".");if(r!==-1){var o=t[e.substr(0,r)];return o==null?void 0:we(o,e.substr(r+1))}}function le(t,e,n){if(t&&e!==void 0&&(!("isFrozen"in Object)||!Object.isFrozen(t)))if(typeof e!="string"&&"length"in e){ct(typeof n!="string"&&"length"in n);for(var s=0,a=e.length;s<a;++s)le(t,e[s],n[s])}else{var i=e.indexOf(".");if(i!==-1){var r=e.substr(0,i),o=e.substr(i+1);if(o==="")n===void 0?Y(t)&&!isNaN(parseInt(r))?t.splice(r,1):delete t[r]:t[r]=n;else{var l=t[r];l&&ae(t,r)||(l=t[r]={}),le(l,o,n)}}else n===void 0?Y(t)&&!isNaN(parseInt(e))?t.splice(e,1):delete t[e]:t[e]=n}}function ta(t){var e={};for(var n in t)ae(t,n)&&(e[n]=t[n]);return e}const oi=[].concat;function na(t){return oi.apply([],t)}const sa="BigUint64Array,BigInt64Array,Array,Boolean,String,Date,RegExp,Blob,File,FileList,FileSystemFileHandle,FileSystemDirectoryHandle,ArrayBuffer,DataView,Uint8ClampedArray,ImageBitmap,ImageData,Map,Set,CryptoKey".split(",").concat(na([8,16,32,64].map(t=>["Int","Uint","Float"].map(e=>e+t+"Array")))).filter(t=>R[t]),li=sa.map(t=>R[t]);ea(sa,t=>[t,!0]);let _e=null;function Tt(t){_e=typeof WeakMap<"u"&&new WeakMap;const e=In(t);return _e=null,e}function In(t){if(!t||typeof t!="object")return t;let e=_e&&_e.get(t);if(e)return e;if(Y(t)){e=[],_e&&_e.set(t,e);for(var n=0,s=t.length;n<s;++n)e.push(In(t[n]))}else if(li.indexOf(t.constructor)>=0)e=t;else{const i=bt(t);for(var a in e=i===Object.prototype?{}:Object.create(i),_e&&_e.set(t,e),t)ae(t,a)&&(e[a]=In(t[a]))}return e}const{toString:ci}={};function Ln(t){return ci.call(t).slice(8,-1)}const jn=typeof Symbol<"u"?Symbol.iterator:"@@iterator",di=typeof jn=="symbol"?function(t){var e;return t!=null&&(e=t[jn])&&e.apply(t)}:function(){return null},Ye={};function me(t){var e,n,s,a;if(arguments.length===1){if(Y(t))return t.slice();if(this===Ye&&typeof t=="string")return[t];if(a=di(t)){for(n=[];!(s=a.next()).done;)n.push(s.value);return n}if(t==null)return[t];if(typeof(e=t.length)=="number"){for(n=new Array(e);e--;)n[e]=t[e];return n}return[t]}for(e=arguments.length,n=new Array(e);e--;)n[e]=arguments[e];return n}const ls=typeof Symbol<"u"?t=>t[Symbol.toStringTag]==="AsyncFunction":()=>!1;var pe=typeof location<"u"&&/^(http|https):\/\/(localhost|127\.0\.0\.1)/.test(location.href);function aa(t,e){pe=t,ia=e}var ia=()=>!0;const ui=!new Error("").stack;function He(){if(ui)try{throw He.arguments,new Error}catch(t){return t}return new Error}function Tn(t,e){var n=t.stack;return n?(e=e||0,n.indexOf(t.name)===0&&(e+=(t.name+t.message).split(`
`).length),n.split(`
`).slice(e).filter(ia).map(s=>`
`+s).join("")):""}var ra=["Unknown","Constraint","Data","TransactionInactive","ReadOnly","Version","NotFound","InvalidState","InvalidAccess","Abort","Timeout","QuotaExceeded","Syntax","DataClone"],cs=["Modify","Bulk","OpenFailed","VersionChange","Schema","Upgrade","InvalidTable","MissingAPI","NoSuchDatabase","InvalidArgument","SubTransaction","Unsupported","Internal","DatabaseClosed","PrematureCommit","ForeignAwait"].concat(ra),pi={VersionChanged:"Database version changed by other database connection",DatabaseClosed:"Database has been closed",Abort:"Transaction aborted",TransactionInactive:"Transaction has already completed or failed",MissingAPI:"IndexedDB API missing. Please visit https://tinyurl.com/y2uuvskb"};function Qe(t,e){this._e=He(),this.name=t,this.message=e}function oa(t,e){return t+". Errors: "+Object.keys(e).map(n=>e[n].toString()).filter((n,s,a)=>a.indexOf(n)===s).join(`
`)}function tn(t,e,n,s){this._e=He(),this.failures=e,this.failedKeys=s,this.successCount=n,this.message=oa(t,e)}function ht(t,e){this._e=He(),this.name="BulkError",this.failures=Object.keys(e).map(n=>e[n]),this.failuresByPos=e,this.message=oa(t,e)}Je(Qe).from(Error).extend({stack:{get:function(){return this._stack||(this._stack=this.name+": "+this.message+Tn(this._e,2))}},toString:function(){return this.name+": "+this.message}}),Je(tn).from(Qe),Je(ht).from(Qe);var ds=cs.reduce((t,e)=>(t[e]=e+"Error",t),{});const hi=Qe;var I=cs.reduce((t,e)=>{var n=e+"Error";function s(a,i){this._e=He(),this.name=n,a?typeof a=="string"?(this.message=`${a}${i?`
 `+i:""}`,this.inner=i||null):typeof a=="object"&&(this.message=`${a.name} ${a.message}`,this.inner=a):(this.message=pi[e]||n,this.inner=null)}return Je(s).from(hi),t[e]=s,t},{});I.Syntax=SyntaxError,I.Type=TypeError,I.Range=RangeError;var Ts=ra.reduce((t,e)=>(t[e+"Error"]=I[e],t),{}),Gt=cs.reduce((t,e)=>(["Syntax","Type","Range"].indexOf(e)===-1&&(t[e+"Error"]=I[e]),t),{});function q(){}function wt(t){return t}function yi(t,e){return t==null||t===wt?e:function(n){return e(t(n))}}function Fe(t,e){return function(){t.apply(this,arguments),e.apply(this,arguments)}}function fi(t,e){return t===q?e:function(){var n=t.apply(this,arguments);n!==void 0&&(arguments[0]=n);var s=this.onsuccess,a=this.onerror;this.onsuccess=null,this.onerror=null;var i=e.apply(this,arguments);return s&&(this.onsuccess=this.onsuccess?Fe(s,this.onsuccess):s),a&&(this.onerror=this.onerror?Fe(a,this.onerror):a),i!==void 0?i:n}}function mi(t,e){return t===q?e:function(){t.apply(this,arguments);var n=this.onsuccess,s=this.onerror;this.onsuccess=this.onerror=null,e.apply(this,arguments),n&&(this.onsuccess=this.onsuccess?Fe(n,this.onsuccess):n),s&&(this.onerror=this.onerror?Fe(s,this.onerror):s)}}function gi(t,e){return t===q?e:function(n){var s=t.apply(this,arguments);X(n,s);var a=this.onsuccess,i=this.onerror;this.onsuccess=null,this.onerror=null;var r=e.apply(this,arguments);return a&&(this.onsuccess=this.onsuccess?Fe(a,this.onsuccess):a),i&&(this.onerror=this.onerror?Fe(i,this.onerror):i),s===void 0?r===void 0?void 0:r:X(s,r)}}function vi(t,e){return t===q?e:function(){return e.apply(this,arguments)!==!1&&t.apply(this,arguments)}}function us(t,e){return t===q?e:function(){var n=t.apply(this,arguments);if(n&&typeof n.then=="function"){for(var s=this,a=arguments.length,i=new Array(a);a--;)i[a]=arguments[a];return n.then(function(){return e.apply(s,i)})}return e.apply(this,arguments)}}Gt.ModifyError=tn,Gt.DexieError=Qe,Gt.BulkError=ht;var kt={};const la=100,[Pn,nn,Cn]=typeof Promise>"u"?[]:(()=>{let t=Promise.resolve();if(typeof crypto>"u"||!crypto.subtle)return[t,bt(t),t];const e=crypto.subtle.digest("SHA-512",new Uint8Array([0]));return[e,bt(e),t]})(),ca=nn&&nn.then,zt=Pn&&Pn.constructor,ps=!!Cn;var qn=!1,bi=Cn?()=>{Cn.then(Bt)}:R.setImmediate?setImmediate.bind(null,Bt):R.MutationObserver?()=>{var t=document.createElement("div");new MutationObserver(()=>{Bt(),t=null}).observe(t,{attributes:!0}),t.setAttribute("i","1")}:()=>{setTimeout(Bt,0)},yt=function(t,e){dt.push([t,e]),sn&&(bi(),sn=!1)},Bn=!0,sn=!0,Pe=[],Ut=[],On=null,Rn=wt,Xe={id:"global",global:!0,ref:0,unhandleds:[],onunhandled:qs,pgp:!1,env:{},finalize:function(){this.unhandleds.forEach(t=>{try{qs(t[0],t[1])}catch{}})}},M=Xe,dt=[],Ce=0,Vt=[];function E(t){if(typeof this!="object")throw new TypeError("Promises must be constructed via new");this._listeners=[],this.onuncatched=q,this._lib=!1;var e=this._PSD=M;if(pe&&(this._stackHolder=He(),this._prev=null,this._numPrev=0),typeof t!="function"){if(t!==kt)throw new TypeError("Not a function");return this._state=arguments[1],this._value=arguments[2],void(this._state===!1&&Nn(this,this._value))}this._state=null,this._value=null,++e.ref,ua(this,t)}const Fn={get:function(){var t=M,e=an;function n(s,a){var i=!t.global&&(t!==M||e!==an);const r=i&&!ke();var o=new E((l,d)=>{hs(this,new da(rn(s,t,i,r),rn(a,t,i,r),l,d,t))});return pe&&ya(o,this),o}return n.prototype=kt,n},set:function(t){be(this,"then",t&&t.prototype===kt?Fn:{get:function(){return t},set:Fn.set})}};function da(t,e,n,s,a){this.onFulfilled=typeof t=="function"?t:null,this.onRejected=typeof e=="function"?e:null,this.resolve=n,this.reject=s,this.psd=a}function ua(t,e){try{e(n=>{if(t._state===null){if(n===t)throw new TypeError("A promise cannot be resolved with itself.");var s=t._lib&&Pt();n&&typeof n.then=="function"?ua(t,(a,i)=>{n instanceof E?n._then(a,i):n.then(a,i)}):(t._state=!0,t._value=n,pa(t)),s&&Ct()}},Nn.bind(null,t))}catch(n){Nn(t,n)}}function Nn(t,e){if(Ut.push(e),t._state===null){var n=t._lib&&Pt();e=Rn(e),t._state=!1,t._value=e,pe&&e!==null&&typeof e=="object"&&!e._promise&&function(s,a,i){try{s.apply(null,i)}catch{}}(()=>{var s=os(e,"stack");e._promise=t,be(e,"stack",{get:()=>qn?s&&(s.get?s.get.apply(e):s.value):t.stack})}),function(s){Pe.some(a=>a._value===s._value)||Pe.push(s)}(t),pa(t),n&&Ct()}}function pa(t){var e=t._listeners;t._listeners=[];for(var n=0,s=e.length;n<s;++n)hs(t,e[n]);var a=t._PSD;--a.ref||a.finalize(),Ce===0&&(++Ce,yt(()=>{--Ce==0&&ys()},[]))}function hs(t,e){if(t._state!==null){var n=t._state?e.onFulfilled:e.onRejected;if(n===null)return(t._state?e.resolve:e.reject)(t._value);++e.psd.ref,++Ce,yt(wi,[n,t,e])}else t._listeners.push(e)}function wi(t,e,n){try{On=e;var s,a=e._value;e._state?s=t(a):(Ut.length&&(Ut=[]),s=t(a),Ut.indexOf(a)===-1&&function(i){for(var r=Pe.length;r;)if(Pe[--r]._value===i._value)return void Pe.splice(r,1)}(e)),n.resolve(s)}catch(i){n.reject(i)}finally{On=null,--Ce==0&&ys(),--n.psd.ref||n.psd.finalize()}}function ha(t,e,n){if(e.length===n)return e;var s="";if(t._state===!1){var a,i,r=t._value;r!=null?(a=r.name||"Error",i=r.message||r,s=Tn(r,0)):(a=r,i=""),e.push(a+(i?": "+i:"")+s)}return pe&&((s=Tn(t._stackHolder,2))&&e.indexOf(s)===-1&&e.push(s),t._prev&&ha(t._prev,e,n)),e}function ya(t,e){var n=e?e._numPrev+1:0;n<100&&(t._prev=e,t._numPrev=n)}function Bt(){Pt()&&Ct()}function Pt(){var t=Bn;return Bn=!1,sn=!1,t}function Ct(){var t,e,n;do for(;dt.length>0;)for(t=dt,dt=[],n=t.length,e=0;e<n;++e){var s=t[e];s[0].apply(null,s[1])}while(dt.length>0);Bn=!0,sn=!0}function ys(){var t=Pe;Pe=[],t.forEach(s=>{s._PSD.onunhandled.call(null,s._value,s)});for(var e=Vt.slice(0),n=e.length;n;)e[--n]()}function Ot(t){return new E(kt,!1,t)}function F(t,e){var n=M;return function(){var s=Pt(),a=M;try{return Ae(n,!0),t.apply(this,arguments)}catch(i){e&&e(i)}finally{Ae(a,!1),s&&Ct()}}}et(E.prototype,{then:Fn,_then:function(t,e){hs(this,new da(null,null,t,e,M))},catch:function(t){if(arguments.length===1)return this.then(null,t);var e=arguments[0],n=arguments[1];return typeof e=="function"?this.then(null,s=>s instanceof e?n(s):Ot(s)):this.then(null,s=>s&&s.name===e?n(s):Ot(s))},finally:function(t){return this.then(e=>(t(),e),e=>(t(),Ot(e)))},stack:{get:function(){if(this._stack)return this._stack;try{qn=!0;var t=ha(this,[],20).join(`
From previous: `);return this._state!==null&&(this._stack=t),t}finally{qn=!1}}},timeout:function(t,e){return t<1/0?new E((n,s)=>{var a=setTimeout(()=>s(new I.Timeout(e)),t);this.then(n,s).finally(clearTimeout.bind(null,a))}):this}}),typeof Symbol<"u"&&Symbol.toStringTag&&be(E.prototype,Symbol.toStringTag,"Dexie.Promise"),Xe.env=fa(),et(E,{all:function(){var t=me.apply(null,arguments).map(Rt);return new E(function(e,n){t.length===0&&e([]);var s=t.length;t.forEach((a,i)=>E.resolve(a).then(r=>{t[i]=r,--s||e(t)},n))})},resolve:t=>{if(t instanceof E)return t;if(t&&typeof t.then=="function")return new E((n,s)=>{t.then(n,s)});var e=new E(kt,!0,t);return ya(e,On),e},reject:Ot,race:function(){var t=me.apply(null,arguments).map(Rt);return new E((e,n)=>{t.map(s=>E.resolve(s).then(e,n))})},PSD:{get:()=>M,set:t=>M=t},totalEchoes:{get:()=>an},newPSD:De,usePSD:st,scheduler:{get:()=>yt,set:t=>{yt=t}},rejectionMapper:{get:()=>Rn,set:t=>{Rn=t}},follow:(t,e)=>new E((n,s)=>De((a,i)=>{var r=M;r.unhandleds=[],r.onunhandled=i,r.finalize=Fe(function(){(function(o){function l(){o(),Vt.splice(Vt.indexOf(l),1)}Vt.push(l),++Ce,yt(()=>{--Ce==0&&ys()},[])})(()=>{this.unhandleds.length===0?a():i(this.unhandleds[0])})},r.finalize),t()},e,n,s))}),zt&&(zt.allSettled&&be(E,"allSettled",function(){const t=me.apply(null,arguments).map(Rt);return new E(e=>{t.length===0&&e([]);let n=t.length;const s=new Array(n);t.forEach((a,i)=>E.resolve(a).then(r=>s[i]={status:"fulfilled",value:r},r=>s[i]={status:"rejected",reason:r}).then(()=>--n||e(s)))})}),zt.any&&typeof AggregateError<"u"&&be(E,"any",function(){const t=me.apply(null,arguments).map(Rt);return new E((e,n)=>{t.length===0&&n(new AggregateError([]));let s=t.length;const a=new Array(s);t.forEach((i,r)=>E.resolve(i).then(o=>e(o),o=>{a[r]=o,--s||n(new AggregateError(a))}))})}));const W={awaits:0,echoes:0,id:0};var ki=0,Wt=[],bn=0,an=0,xi=0;function De(t,e,n,s){var a=M,i=Object.create(a);i.parent=a,i.ref=0,i.global=!1,i.id=++xi;var r=Xe.env;i.env=ps?{Promise:E,PromiseProp:{value:E,configurable:!0,writable:!0},all:E.all,race:E.race,allSettled:E.allSettled,any:E.any,resolve:E.resolve,reject:E.reject,nthen:Ps(r.nthen,i),gthen:Ps(r.gthen,i)}:{},e&&X(i,e),++a.ref,i.finalize=function(){--this.parent.ref||this.parent.finalize()};var o=st(i,t,n,s);return i.ref===0&&i.finalize(),o}function nt(){return W.id||(W.id=++ki),++W.awaits,W.echoes+=la,W.id}function ke(){return!!W.awaits&&(--W.awaits==0&&(W.id=0),W.echoes=W.awaits*la,!0)}function Rt(t){return W.echoes&&t&&t.constructor===zt?(nt(),t.then(e=>(ke(),e),e=>(ke(),z(e)))):t}function Si(t){++an,W.echoes&&--W.echoes!=0||(W.echoes=W.id=0),Wt.push(M),Ae(t,!0)}function _i(){var t=Wt[Wt.length-1];Wt.pop(),Ae(t,!1)}function Ae(t,e){var n=M;if((e?!W.echoes||bn++&&t===M:!bn||--bn&&t===M)||ma(e?Si.bind(null,t):_i),t!==M&&(M=t,n===Xe&&(Xe.env=fa()),ps)){var s=Xe.env.Promise,a=t.env;nn.then=a.nthen,s.prototype.then=a.gthen,(n.global||t.global)&&(Object.defineProperty(R,"Promise",a.PromiseProp),s.all=a.all,s.race=a.race,s.resolve=a.resolve,s.reject=a.reject,a.allSettled&&(s.allSettled=a.allSettled),a.any&&(s.any=a.any))}}function fa(){var t=R.Promise;return ps?{Promise:t,PromiseProp:Object.getOwnPropertyDescriptor(R,"Promise"),all:t.all,race:t.race,allSettled:t.allSettled,any:t.any,resolve:t.resolve,reject:t.reject,nthen:nn.then,gthen:t.prototype.then}:{}}function st(t,e,n,s,a){var i=M;try{return Ae(t,!0),e(n,s,a)}finally{Ae(i,!1)}}function ma(t){ca.call(Pn,t)}function rn(t,e,n,s){return typeof t!="function"?t:function(){var a=M;n&&nt(),Ae(e,!0);try{return t.apply(this,arguments)}finally{Ae(a,!1),s&&ma(ke)}}}function Ps(t,e){return function(n,s){return t.call(this,rn(n,e),rn(s,e))}}(""+ca).indexOf("[native code]")===-1&&(nt=ke=q);const Cs="unhandledrejection";function qs(t,e){var n;try{n=e.onuncatched(t)}catch{}if(n!==!1)try{var s,a={promise:e,reason:t};if(R.document&&document.createEvent?((s=document.createEvent("Event")).initEvent(Cs,!0,!0),X(s,a)):R.CustomEvent&&X(s=new CustomEvent(Cs,{detail:a}),a),s&&R.dispatchEvent&&(dispatchEvent(s),!R.PromiseRejectionEvent&&R.onunhandledrejection))try{R.onunhandledrejection(s)}catch{}pe&&s&&!s.defaultPrevented&&console.warn(`Unhandled rejection: ${t.stack||t}`)}catch{}}var z=E.reject;function Kn(t,e,n,s){if(t.idbdb&&(t._state.openComplete||M.letThrough||t._vip)){var a=t._createTransaction(e,n,t._dbSchema);try{a.create(),t._state.PR1398_maxLoop=3}catch(i){return i.name===ds.InvalidState&&t.isOpen()&&--t._state.PR1398_maxLoop>0?(console.warn("Dexie: Need to reopen db"),t._close(),t.open().then(()=>Kn(t,e,n,s))):z(i)}return a._promise(e,(i,r)=>De(()=>(M.trans=a,s(i,r,a)))).then(i=>a._completion.then(()=>i))}if(t._state.openComplete)return z(new I.DatabaseClosed(t._state.dbOpenError));if(!t._state.isBeingOpened){if(!t._options.autoOpen)return z(new I.DatabaseClosed);t.open().catch(q)}return t._state.dbReadyPromise.then(()=>Kn(t,e,n,s))}const Bs="3.2.7",je="￿",Hn=-1/0,ye="Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.",ga="String expected.",ft=[],pn=typeof navigator<"u"&&/(MSIE|Trident|Edge)/.test(navigator.userAgent),$i=pn,Ei=pn,va=t=>!/(dexie\.js|dexie\.min\.js)/.test(t),hn="__dbnames",wn="readonly",kn="readwrite";function Ne(t,e){return t?e?function(){return t.apply(this,arguments)&&e.apply(this,arguments)}:t:e}const ba={type:3,lower:-1/0,lowerOpen:!1,upper:[[]],upperOpen:!1};function Ft(t){return typeof t!="string"||/\./.test(t)?e=>e:e=>(e[t]===void 0&&t in e&&delete(e=Tt(e))[t],e)}class Di{_trans(e,n,s){const a=this._tx||M.trans,i=this.name;function r(l,d,c){if(!c.schema[i])throw new I.NotFound("Table "+i+" not part of transaction");return n(c.idbtrans,c)}const o=Pt();try{return a&&a.db===this.db?a===M.trans?a._promise(e,r,s):De(()=>a._promise(e,r,s),{trans:a,transless:M.transless||M}):Kn(this.db,e,[this.name],r)}finally{o&&Ct()}}get(e,n){return e&&e.constructor===Object?this.where(e).first(n):this._trans("readonly",s=>this.core.get({trans:s,key:e}).then(a=>this.hook.reading.fire(a))).then(n)}where(e){if(typeof e=="string")return new this.db.WhereClause(this,e);if(Y(e))return new this.db.WhereClause(this,`[${e.join("+")}]`);const n=G(e);if(n.length===1)return this.where(n[0]).equals(e[n[0]]);const s=this.schema.indexes.concat(this.schema.primKey).filter(d=>{if(d.compound&&n.every(c=>d.keyPath.indexOf(c)>=0)){for(let c=0;c<n.length;++c)if(n.indexOf(d.keyPath[c])===-1)return!1;return!0}return!1}).sort((d,c)=>d.keyPath.length-c.keyPath.length)[0];if(s&&this.db._maxKey!==je){const d=s.keyPath.slice(0,n.length);return this.where(d).equals(d.map(c=>e[c]))}!s&&pe&&console.warn(`The query ${JSON.stringify(e)} on ${this.name} would benefit of a compound index [${n.join("+")}]`);const{idxByName:a}=this.schema,i=this.db._deps.indexedDB;function r(d,c){try{return i.cmp(d,c)===0}catch{return!1}}const[o,l]=n.reduce(([d,c],u)=>{const p=a[u],h=e[u];return[d||p,d||!p?Ne(c,p&&p.multi?v=>{const f=we(v,u);return Y(f)&&f.some(g=>r(h,g))}:v=>r(h,we(v,u))):c]},[null,null]);return o?this.where(o.name).equals(e[o.keyPath]).filter(l):s?this.filter(l):this.where(n).equals("")}filter(e){return this.toCollection().and(e)}count(e){return this.toCollection().count(e)}offset(e){return this.toCollection().offset(e)}limit(e){return this.toCollection().limit(e)}each(e){return this.toCollection().each(e)}toArray(e){return this.toCollection().toArray(e)}toCollection(){return new this.db.Collection(new this.db.WhereClause(this))}orderBy(e){return new this.db.Collection(new this.db.WhereClause(this,Y(e)?`[${e.join("+")}]`:e))}reverse(){return this.toCollection().reverse()}mapToClass(e){this.schema.mappedClass=e;const n=s=>{if(!s)return s;const a=Object.create(e.prototype);for(var i in s)if(ae(s,i))try{a[i]=s[i]}catch{}return a};return this.schema.readHook&&this.hook.reading.unsubscribe(this.schema.readHook),this.schema.readHook=n,this.hook("reading",n),e}defineClass(){return this.mapToClass(function(e){X(this,e)})}add(e,n){const{auto:s,keyPath:a}=this.schema.primKey;let i=e;return a&&s&&(i=Ft(a)(e)),this._trans("readwrite",r=>this.core.mutate({trans:r,type:"add",keys:n!=null?[n]:null,values:[i]})).then(r=>r.numFailures?E.reject(r.failures[0]):r.lastResult).then(r=>{if(a)try{le(e,a,r)}catch{}return r})}update(e,n){if(typeof e!="object"||Y(e))return this.where(":id").equals(e).modify(n);{const s=we(e,this.schema.primKey.keyPath);if(s===void 0)return z(new I.InvalidArgument("Given object does not contain its primary key"));try{typeof n!="function"?G(n).forEach(a=>{le(e,a,n[a])}):n(e,{value:e,primKey:s})}catch{}return this.where(":id").equals(s).modify(n)}}put(e,n){const{auto:s,keyPath:a}=this.schema.primKey;let i=e;return a&&s&&(i=Ft(a)(e)),this._trans("readwrite",r=>this.core.mutate({trans:r,type:"put",values:[i],keys:n!=null?[n]:null})).then(r=>r.numFailures?E.reject(r.failures[0]):r.lastResult).then(r=>{if(a)try{le(e,a,r)}catch{}return r})}delete(e){return this._trans("readwrite",n=>this.core.mutate({trans:n,type:"delete",keys:[e]})).then(n=>n.numFailures?E.reject(n.failures[0]):void 0)}clear(){return this._trans("readwrite",e=>this.core.mutate({trans:e,type:"deleteRange",range:ba})).then(e=>e.numFailures?E.reject(e.failures[0]):void 0)}bulkGet(e){return this._trans("readonly",n=>this.core.getMany({keys:e,trans:n}).then(s=>s.map(a=>this.hook.reading.fire(a))))}bulkAdd(e,n,s){const a=Array.isArray(n)?n:void 0,i=(s=s||(a?void 0:n))?s.allKeys:void 0;return this._trans("readwrite",r=>{const{auto:o,keyPath:l}=this.schema.primKey;if(l&&a)throw new I.InvalidArgument("bulkAdd(): keys argument invalid on tables with inbound keys");if(a&&a.length!==e.length)throw new I.InvalidArgument("Arguments objects and keys must have the same length");const d=e.length;let c=l&&o?e.map(Ft(l)):e;return this.core.mutate({trans:r,type:"add",keys:a,values:c,wantResults:i}).then(({numFailures:u,results:p,lastResult:h,failures:v})=>{if(u===0)return i?p:h;throw new ht(`${this.name}.bulkAdd(): ${u} of ${d} operations failed`,v)})})}bulkPut(e,n,s){const a=Array.isArray(n)?n:void 0,i=(s=s||(a?void 0:n))?s.allKeys:void 0;return this._trans("readwrite",r=>{const{auto:o,keyPath:l}=this.schema.primKey;if(l&&a)throw new I.InvalidArgument("bulkPut(): keys argument invalid on tables with inbound keys");if(a&&a.length!==e.length)throw new I.InvalidArgument("Arguments objects and keys must have the same length");const d=e.length;let c=l&&o?e.map(Ft(l)):e;return this.core.mutate({trans:r,type:"put",keys:a,values:c,wantResults:i}).then(({numFailures:u,results:p,lastResult:h,failures:v})=>{if(u===0)return i?p:h;throw new ht(`${this.name}.bulkPut(): ${u} of ${d} operations failed`,v)})})}bulkDelete(e){const n=e.length;return this._trans("readwrite",s=>this.core.mutate({trans:s,type:"delete",keys:e})).then(({numFailures:s,lastResult:a,failures:i})=>{if(s===0)return a;throw new ht(`${this.name}.bulkDelete(): ${s} of ${n} operations failed`,i)})}}function mt(t){var e={},n=function(r,o){if(o){for(var l=arguments.length,d=new Array(l-1);--l;)d[l-1]=arguments[l];return e[r].subscribe.apply(null,d),t}if(typeof r=="string")return e[r]};n.addEventType=i;for(var s=1,a=arguments.length;s<a;++s)i(arguments[s]);return n;function i(r,o,l){if(typeof r!="object"){var d;o||(o=vi),l||(l=q);var c={subscribers:[],fire:l,subscribe:function(u){c.subscribers.indexOf(u)===-1&&(c.subscribers.push(u),c.fire=o(c.fire,u))},unsubscribe:function(u){c.subscribers=c.subscribers.filter(function(p){return p!==u}),c.fire=c.subscribers.reduce(o,l)}};return e[r]=n[r]=c,c}G(d=r).forEach(function(u){var p=d[u];if(Y(p))i(u,d[u][0],d[u][1]);else{if(p!=="asap")throw new I.InvalidArgument("Invalid event config");var h=i(u,wt,function(){for(var v=arguments.length,f=new Array(v);v--;)f[v]=arguments[v];h.subscribers.forEach(function(g){Zs(function(){g.apply(null,f)})})})}})}}function rt(t,e){return Je(e).from({prototype:t}),e}function Ve(t,e){return!(t.filter||t.algorithm||t.or)&&(e?t.justLimit:!t.replayFilter)}function xn(t,e){t.filter=Ne(t.filter,e)}function Sn(t,e,n){var s=t.replayFilter;t.replayFilter=s?()=>Ne(s(),e()):e,t.justLimit=n&&!s}function Yt(t,e){if(t.isPrimKey)return e.primaryKey;const n=e.getIndexByKeyPath(t.index);if(!n)throw new I.Schema("KeyPath "+t.index+" on object store "+e.name+" is not indexed");return n}function Os(t,e,n){const s=Yt(t,e.schema);return e.openCursor({trans:n,values:!t.keysOnly,reverse:t.dir==="prev",unique:!!t.unique,query:{index:s,range:t.range}})}function Nt(t,e,n,s){const a=t.replayFilter?Ne(t.filter,t.replayFilter()):t.filter;if(t.or){const i={},r=(o,l,d)=>{if(!a||a(l,d,p=>l.stop(p),p=>l.fail(p))){var c=l.primaryKey,u=""+c;u==="[object ArrayBuffer]"&&(u=""+new Uint8Array(c)),ae(i,u)||(i[u]=!0,e(o,l,d))}};return Promise.all([t.or._iterate(r,n),Rs(Os(t,s,n),t.algorithm,r,!t.keysOnly&&t.valueMapper)])}return Rs(Os(t,s,n),Ne(t.algorithm,a),e,!t.keysOnly&&t.valueMapper)}function Rs(t,e,n,s){var a=F(s?(i,r,o)=>n(s(i),r,o):n);return t.then(i=>{if(i)return i.start(()=>{var r=()=>i.continue();e&&!e(i,o=>r=o,o=>{i.stop(o),r=q},o=>{i.fail(o),r=q})||a(i.value,i,o=>r=o),r()})})}function Q(t,e){try{const n=Fs(t),s=Fs(e);if(n!==s)return n==="Array"?1:s==="Array"?-1:n==="binary"?1:s==="binary"?-1:n==="string"?1:s==="string"?-1:n==="Date"?1:s!=="Date"?NaN:-1;switch(n){case"number":case"Date":case"string":return t>e?1:t<e?-1:0;case"binary":return function(a,i){const r=a.length,o=i.length,l=r<o?r:o;for(let d=0;d<l;++d)if(a[d]!==i[d])return a[d]<i[d]?-1:1;return r===o?0:r<o?-1:1}(Ns(t),Ns(e));case"Array":return function(a,i){const r=a.length,o=i.length,l=r<o?r:o;for(let d=0;d<l;++d){const c=Q(a[d],i[d]);if(c!==0)return c}return r===o?0:r<o?-1:1}(t,e)}}catch{}return NaN}function Fs(t){const e=typeof t;if(e!=="object")return e;if(ArrayBuffer.isView(t))return"binary";const n=Ln(t);return n==="ArrayBuffer"?"binary":n}function Ns(t){return t instanceof Uint8Array?t:ArrayBuffer.isView(t)?new Uint8Array(t.buffer,t.byteOffset,t.byteLength):new Uint8Array(t)}class Ai{_read(e,n){var s=this._ctx;return s.error?s.table._trans(null,z.bind(null,s.error)):s.table._trans("readonly",e).then(n)}_write(e){var n=this._ctx;return n.error?n.table._trans(null,z.bind(null,n.error)):n.table._trans("readwrite",e,"locked")}_addAlgorithm(e){var n=this._ctx;n.algorithm=Ne(n.algorithm,e)}_iterate(e,n){return Nt(this._ctx,e,n,this._ctx.table.core)}clone(e){var n=Object.create(this.constructor.prototype),s=Object.create(this._ctx);return e&&X(s,e),n._ctx=s,n}raw(){return this._ctx.valueMapper=null,this}each(e){var n=this._ctx;return this._read(s=>Nt(n,e,s,n.table.core))}count(e){return this._read(n=>{const s=this._ctx,a=s.table.core;if(Ve(s,!0))return a.count({trans:n,query:{index:Yt(s,a.schema),range:s.range}}).then(r=>Math.min(r,s.limit));var i=0;return Nt(s,()=>(++i,!1),n,a).then(()=>i)}).then(e)}sortBy(e,n){const s=e.split(".").reverse(),a=s[0],i=s.length-1;function r(d,c){return c?r(d[s[c]],c-1):d[a]}var o=this._ctx.dir==="next"?1:-1;function l(d,c){var u=r(d,i),p=r(c,i);return u<p?-o:u>p?o:0}return this.toArray(function(d){return d.sort(l)}).then(n)}toArray(e){return this._read(n=>{var s=this._ctx;if(s.dir==="next"&&Ve(s,!0)&&s.limit>0){const{valueMapper:a}=s,i=Yt(s,s.table.core.schema);return s.table.core.query({trans:n,limit:s.limit,values:!0,query:{index:i,range:s.range}}).then(({result:r})=>a?r.map(a):r)}{const a=[];return Nt(s,i=>a.push(i),n,s.table.core).then(()=>a)}},e)}offset(e){var n=this._ctx;return e<=0||(n.offset+=e,Ve(n)?Sn(n,()=>{var s=e;return(a,i)=>s===0||(s===1?(--s,!1):(i(()=>{a.advance(s),s=0}),!1))}):Sn(n,()=>{var s=e;return()=>--s<0})),this}limit(e){return this._ctx.limit=Math.min(this._ctx.limit,e),Sn(this._ctx,()=>{var n=e;return function(s,a,i){return--n<=0&&a(i),n>=0}},!0),this}until(e,n){return xn(this._ctx,function(s,a,i){return!e(s.value)||(a(i),n)}),this}first(e){return this.limit(1).toArray(function(n){return n[0]}).then(e)}last(e){return this.reverse().first(e)}filter(e){var n,s;return xn(this._ctx,function(a){return e(a.value)}),n=this._ctx,s=e,n.isMatch=Ne(n.isMatch,s),this}and(e){return this.filter(e)}or(e){return new this.db.WhereClause(this._ctx.table,e,this)}reverse(){return this._ctx.dir=this._ctx.dir==="prev"?"next":"prev",this._ondirectionchange&&this._ondirectionchange(this._ctx.dir),this}desc(){return this.reverse()}eachKey(e){var n=this._ctx;return n.keysOnly=!n.isMatch,this.each(function(s,a){e(a.key,a)})}eachUniqueKey(e){return this._ctx.unique="unique",this.eachKey(e)}eachPrimaryKey(e){var n=this._ctx;return n.keysOnly=!n.isMatch,this.each(function(s,a){e(a.primaryKey,a)})}keys(e){var n=this._ctx;n.keysOnly=!n.isMatch;var s=[];return this.each(function(a,i){s.push(i.key)}).then(function(){return s}).then(e)}primaryKeys(e){var n=this._ctx;if(n.dir==="next"&&Ve(n,!0)&&n.limit>0)return this._read(a=>{var i=Yt(n,n.table.core.schema);return n.table.core.query({trans:a,values:!1,limit:n.limit,query:{index:i,range:n.range}})}).then(({result:a})=>a).then(e);n.keysOnly=!n.isMatch;var s=[];return this.each(function(a,i){s.push(i.primaryKey)}).then(function(){return s}).then(e)}uniqueKeys(e){return this._ctx.unique="unique",this.keys(e)}firstKey(e){return this.limit(1).keys(function(n){return n[0]}).then(e)}lastKey(e){return this.reverse().firstKey(e)}distinct(){var e=this._ctx,n=e.index&&e.table.schema.idxByName[e.index];if(!n||!n.multi)return this;var s={};return xn(this._ctx,function(a){var i=a.primaryKey.toString(),r=ae(s,i);return s[i]=!0,!r}),this}modify(e){var n=this._ctx;return this._write(s=>{var a;if(typeof e=="function")a=e;else{var i=G(e),r=i.length;a=function(f){for(var g=!1,y=0;y<r;++y){var m=i[y],w=e[m];we(f,m)!==w&&(le(f,m,w),g=!0)}return g}}const o=n.table.core,{outbound:l,extractKey:d}=o.schema.primaryKey,c=this.db._options.modifyChunkSize||200,u=[];let p=0;const h=[],v=(f,g)=>{const{failures:y,numFailures:m}=g;p+=f-m;for(let w of G(y))u.push(y[w])};return this.clone().primaryKeys().then(f=>{const g=y=>{const m=Math.min(c,f.length-y);return o.getMany({trans:s,keys:f.slice(y,y+m),cache:"immutable"}).then(w=>{const k=[],x=[],b=l?[]:null,S=[];for(let _=0;_<m;++_){const T=w[_],L={value:Tt(T),primKey:f[y+_]};a.call(L,L.value,L)!==!1&&(L.value==null?S.push(f[y+_]):l||Q(d(T),d(L.value))===0?(x.push(L.value),l&&b.push(f[y+_])):(S.push(f[y+_]),k.push(L.value)))}const A=Ve(n)&&n.limit===1/0&&(typeof e!="function"||e===_n)&&{index:n.index,range:n.range};return Promise.resolve(k.length>0&&o.mutate({trans:s,type:"add",values:k}).then(_=>{for(let T in _.failures)S.splice(parseInt(T),1);v(k.length,_)})).then(()=>(x.length>0||A&&typeof e=="object")&&o.mutate({trans:s,type:"put",keys:b,values:x,criteria:A,changeSpec:typeof e!="function"&&e}).then(_=>v(x.length,_))).then(()=>(S.length>0||A&&e===_n)&&o.mutate({trans:s,type:"delete",keys:S,criteria:A}).then(_=>v(S.length,_))).then(()=>f.length>y+m&&g(y+c))})};return g(0).then(()=>{if(u.length>0)throw new tn("Error modifying one or more objects",u,p,h);return f.length})})})}delete(){var e=this._ctx,n=e.range;return Ve(e)&&(e.isPrimKey&&!Ei||n.type===3)?this._write(s=>{const{primaryKey:a}=e.table.core.schema,i=n;return e.table.core.count({trans:s,query:{index:a,range:i}}).then(r=>e.table.core.mutate({trans:s,type:"deleteRange",range:i}).then(({failures:o,lastResult:l,results:d,numFailures:c})=>{if(c)throw new tn("Could not delete some values",Object.keys(o).map(u=>o[u]),r-c);return r-c}))}):this.modify(_n)}}const _n=(t,e)=>e.value=null;function Mi(t,e){return t<e?-1:t===e?0:1}function Ii(t,e){return t>e?-1:t===e?0:1}function se(t,e,n){var s=t instanceof ka?new t.Collection(t):t;return s._ctx.error=n?new n(e):new TypeError(e),s}function We(t){return new t.Collection(t,()=>wa("")).limit(0)}function Li(t,e,n,s,a,i){for(var r=Math.min(t.length,s.length),o=-1,l=0;l<r;++l){var d=e[l];if(d!==s[l])return a(t[l],n[l])<0?t.substr(0,l)+n[l]+n.substr(l+1):a(t[l],s[l])<0?t.substr(0,l)+s[l]+n.substr(l+1):o>=0?t.substr(0,o)+e[o]+n.substr(o+1):null;a(t[l],d)<0&&(o=l)}return r<s.length&&i==="next"?t+n.substr(t.length):r<t.length&&i==="prev"?t.substr(0,n.length):o<0?null:t.substr(0,o)+s[o]+n.substr(o+1)}function Kt(t,e,n,s){var a,i,r,o,l,d,c,u=n.length;if(!n.every(f=>typeof f=="string"))return se(t,ga);function p(f){a=function(y){return y==="next"?m=>m.toUpperCase():m=>m.toLowerCase()}(f),i=function(y){return y==="next"?m=>m.toLowerCase():m=>m.toUpperCase()}(f),r=f==="next"?Mi:Ii;var g=n.map(function(y){return{lower:i(y),upper:a(y)}}).sort(function(y,m){return r(y.lower,m.lower)});o=g.map(function(y){return y.upper}),l=g.map(function(y){return y.lower}),d=f,c=f==="next"?"":s}p("next");var h=new t.Collection(t,()=>Se(o[0],l[u-1]+s));h._ondirectionchange=function(f){p(f)};var v=0;return h._addAlgorithm(function(f,g,y){var m=f.key;if(typeof m!="string")return!1;var w=i(m);if(e(w,l,v))return!0;for(var k=null,x=v;x<u;++x){var b=Li(m,w,o[x],l[x],r,d);b===null&&k===null?v=x+1:(k===null||r(k,b)>0)&&(k=b)}return g(k!==null?function(){f.continue(k+c)}:y),!1}),h}function Se(t,e,n,s){return{type:2,lower:t,upper:e,lowerOpen:n,upperOpen:s}}function wa(t){return{type:1,lower:t,upper:t}}class ka{get Collection(){return this._ctx.table.db.Collection}between(e,n,s,a){s=s!==!1,a=a===!0;try{return this._cmp(e,n)>0||this._cmp(e,n)===0&&(s||a)&&(!s||!a)?We(this):new this.Collection(this,()=>Se(e,n,!s,!a))}catch{return se(this,ye)}}equals(e){return e==null?se(this,ye):new this.Collection(this,()=>wa(e))}above(e){return e==null?se(this,ye):new this.Collection(this,()=>Se(e,void 0,!0))}aboveOrEqual(e){return e==null?se(this,ye):new this.Collection(this,()=>Se(e,void 0,!1))}below(e){return e==null?se(this,ye):new this.Collection(this,()=>Se(void 0,e,!1,!0))}belowOrEqual(e){return e==null?se(this,ye):new this.Collection(this,()=>Se(void 0,e))}startsWith(e){return typeof e!="string"?se(this,ga):this.between(e,e+je,!0,!0)}startsWithIgnoreCase(e){return e===""?this.startsWith(e):Kt(this,(n,s)=>n.indexOf(s[0])===0,[e],je)}equalsIgnoreCase(e){return Kt(this,(n,s)=>n===s[0],[e],"")}anyOfIgnoreCase(){var e=me.apply(Ye,arguments);return e.length===0?We(this):Kt(this,(n,s)=>s.indexOf(n)!==-1,e,"")}startsWithAnyOfIgnoreCase(){var e=me.apply(Ye,arguments);return e.length===0?We(this):Kt(this,(n,s)=>s.some(a=>n.indexOf(a)===0),e,je)}anyOf(){const e=me.apply(Ye,arguments);let n=this._cmp;try{e.sort(n)}catch{return se(this,ye)}if(e.length===0)return We(this);const s=new this.Collection(this,()=>Se(e[0],e[e.length-1]));s._ondirectionchange=i=>{n=i==="next"?this._ascending:this._descending,e.sort(n)};let a=0;return s._addAlgorithm((i,r,o)=>{const l=i.key;for(;n(l,e[a])>0;)if(++a,a===e.length)return r(o),!1;return n(l,e[a])===0||(r(()=>{i.continue(e[a])}),!1)}),s}notEqual(e){return this.inAnyRange([[Hn,e],[e,this.db._maxKey]],{includeLowers:!1,includeUppers:!1})}noneOf(){const e=me.apply(Ye,arguments);if(e.length===0)return new this.Collection(this);try{e.sort(this._ascending)}catch{return se(this,ye)}const n=e.reduce((s,a)=>s?s.concat([[s[s.length-1][1],a]]):[[Hn,a]],null);return n.push([e[e.length-1],this.db._maxKey]),this.inAnyRange(n,{includeLowers:!1,includeUppers:!1})}inAnyRange(e,n){const s=this._cmp,a=this._ascending,i=this._descending,r=this._min,o=this._max;if(e.length===0)return We(this);if(!e.every(m=>m[0]!==void 0&&m[1]!==void 0&&a(m[0],m[1])<=0))return se(this,"First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower",I.InvalidArgument);const l=!n||n.includeLowers!==!1,d=n&&n.includeUppers===!0;let c,u=a;function p(m,w){return u(m[0],w[0])}try{c=e.reduce(function(m,w){let k=0,x=m.length;for(;k<x;++k){const b=m[k];if(s(w[0],b[1])<0&&s(w[1],b[0])>0){b[0]=r(b[0],w[0]),b[1]=o(b[1],w[1]);break}}return k===x&&m.push(w),m},[]),c.sort(p)}catch{return se(this,ye)}let h=0;const v=d?m=>a(m,c[h][1])>0:m=>a(m,c[h][1])>=0,f=l?m=>i(m,c[h][0])>0:m=>i(m,c[h][0])>=0;let g=v;const y=new this.Collection(this,()=>Se(c[0][0],c[c.length-1][1],!l,!d));return y._ondirectionchange=m=>{m==="next"?(g=v,u=a):(g=f,u=i),c.sort(p)},y._addAlgorithm((m,w,k)=>{for(var x=m.key;g(x);)if(++h,h===c.length)return w(k),!1;return!!function(b){return!v(b)&&!f(b)}(x)||(this._cmp(x,c[h][1])===0||this._cmp(x,c[h][0])===0||w(()=>{u===a?m.continue(c[h][0]):m.continue(c[h][1])}),!1)}),y}startsWithAnyOf(){const e=me.apply(Ye,arguments);return e.every(n=>typeof n=="string")?e.length===0?We(this):this.inAnyRange(e.map(n=>[n,n+je])):se(this,"startsWithAnyOf() only works with strings")}}function de(t){return F(function(e){return xt(e),t(e.target.error),!1})}function xt(t){t.stopPropagation&&t.stopPropagation(),t.preventDefault&&t.preventDefault()}const St="storagemutated",$e="x-storagemutated-1",Me=mt(null,St);class ji{_lock(){return ct(!M.global),++this._reculock,this._reculock!==1||M.global||(M.lockOwnerFor=this),this}_unlock(){if(ct(!M.global),--this._reculock==0)for(M.global||(M.lockOwnerFor=null);this._blockedFuncs.length>0&&!this._locked();){var e=this._blockedFuncs.shift();try{st(e[1],e[0])}catch{}}return this}_locked(){return this._reculock&&M.lockOwnerFor!==this}create(e){if(!this.mode)return this;const n=this.db.idbdb,s=this.db._state.dbOpenError;if(ct(!this.idbtrans),!e&&!n)switch(s&&s.name){case"DatabaseClosedError":throw new I.DatabaseClosed(s);case"MissingAPIError":throw new I.MissingAPI(s.message,s);default:throw new I.OpenFailed(s)}if(!this.active)throw new I.TransactionInactive;return ct(this._completion._state===null),(e=this.idbtrans=e||(this.db.core?this.db.core.transaction(this.storeNames,this.mode,{durability:this.chromeTransactionDurability}):n.transaction(this.storeNames,this.mode,{durability:this.chromeTransactionDurability}))).onerror=F(a=>{xt(a),this._reject(e.error)}),e.onabort=F(a=>{xt(a),this.active&&this._reject(new I.Abort(e.error)),this.active=!1,this.on("abort").fire(a)}),e.oncomplete=F(()=>{this.active=!1,this._resolve(),"mutatedParts"in e&&Me.storagemutated.fire(e.mutatedParts)}),this}_promise(e,n,s){if(e==="readwrite"&&this.mode!=="readwrite")return z(new I.ReadOnly("Transaction is readonly"));if(!this.active)return z(new I.TransactionInactive);if(this._locked())return new E((i,r)=>{this._blockedFuncs.push([()=>{this._promise(e,n,s).then(i,r)},M])});if(s)return De(()=>{var i=new E((r,o)=>{this._lock();const l=n(r,o,this);l&&l.then&&l.then(r,o)});return i.finally(()=>this._unlock()),i._lib=!0,i});var a=new E((i,r)=>{var o=n(i,r,this);o&&o.then&&o.then(i,r)});return a._lib=!0,a}_root(){return this.parent?this.parent._root():this}waitFor(e){var n=this._root();const s=E.resolve(e);if(n._waitingFor)n._waitingFor=n._waitingFor.then(()=>s);else{n._waitingFor=s,n._waitingQueue=[];var a=n.idbtrans.objectStore(n.storeNames[0]);(function r(){for(++n._spinCount;n._waitingQueue.length;)n._waitingQueue.shift()();n._waitingFor&&(a.get(-1/0).onsuccess=r)})()}var i=n._waitingFor;return new E((r,o)=>{s.then(l=>n._waitingQueue.push(F(r.bind(null,l))),l=>n._waitingQueue.push(F(o.bind(null,l)))).finally(()=>{n._waitingFor===i&&(n._waitingFor=null)})})}abort(){this.active&&(this.active=!1,this.idbtrans&&this.idbtrans.abort(),this._reject(new I.Abort))}table(e){const n=this._memoizedTables||(this._memoizedTables={});if(ae(n,e))return n[e];const s=this.schema[e];if(!s)throw new I.NotFound("Table "+e+" not part of transaction");const a=new this.db.Table(e,s,this);return a.core=this.db.core.table(e),n[e]=a,a}}function Gn(t,e,n,s,a,i,r){return{name:t,keyPath:e,unique:n,multi:s,auto:a,compound:i,src:(n&&!r?"&":"")+(s?"*":"")+(a?"++":"")+xa(e)}}function xa(t){return typeof t=="string"?t:t?"["+[].join.call(t,"+")+"]":""}function Sa(t,e,n){return{name:t,primKey:e,indexes:n,mappedClass:null,idxByName:ea(n,s=>[s.name,s])}}let _t=t=>{try{return t.only([[]]),_t=()=>[[]],[[]]}catch{return _t=()=>je,je}};function zn(t){return t==null?()=>{}:typeof t=="string"?function(e){return e.split(".").length===1?s=>s[e]:s=>we(s,e)}(t):e=>we(e,t)}function Ks(t){return[].slice.call(t)}let Ti=0;function gt(t){return t==null?":id":typeof t=="string"?t:`[${t.join("+")}]`}function Pi(t,e,n){function s(l){if(l.type===3)return null;if(l.type===4)throw new Error("Cannot convert never type to IDBKeyRange");const{lower:d,upper:c,lowerOpen:u,upperOpen:p}=l;return d===void 0?c===void 0?null:e.upperBound(c,!!p):c===void 0?e.lowerBound(d,!!u):e.bound(d,c,!!u,!!p)}const{schema:a,hasGetAll:i}=function(l,d){const c=Ks(l.objectStoreNames);return{schema:{name:l.name,tables:c.map(u=>d.objectStore(u)).map(u=>{const{keyPath:p,autoIncrement:h}=u,v=Y(p),f=p==null,g={},y={name:u.name,primaryKey:{name:null,isPrimaryKey:!0,outbound:f,compound:v,keyPath:p,autoIncrement:h,unique:!0,extractKey:zn(p)},indexes:Ks(u.indexNames).map(m=>u.index(m)).map(m=>{const{name:w,unique:k,multiEntry:x,keyPath:b}=m,S={name:w,compound:Y(b),keyPath:b,unique:k,multiEntry:x,extractKey:zn(b)};return g[gt(b)]=S,S}),getIndexByKeyPath:m=>g[gt(m)]};return g[":id"]=y.primaryKey,p!=null&&(g[gt(p)]=y.primaryKey),y})},hasGetAll:c.length>0&&"getAll"in d.objectStore(c[0])&&!(typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604)}}(t,n),r=a.tables.map(l=>function(d){const c=d.name;return{name:c,schema:d,mutate:function({trans:u,type:p,keys:h,values:v,range:f}){return new Promise((g,y)=>{g=F(g);const m=u.objectStore(c),w=m.keyPath==null,k=p==="put"||p==="add";if(!k&&p!=="delete"&&p!=="deleteRange")throw new Error("Invalid operation type: "+p);const{length:x}=h||v||{length:1};if(h&&v&&h.length!==v.length)throw new Error("Given keys array must have same length as given values array.");if(x===0)return g({numFailures:0,failures:{},results:[],lastResult:void 0});let b;const S=[],A=[];let _=0;const T=H=>{++_,xt(H)};if(p==="deleteRange"){if(f.type===4)return g({numFailures:_,failures:A,results:[],lastResult:void 0});f.type===3?S.push(b=m.clear()):S.push(b=m.delete(s(f)))}else{const[H,K]=k?w?[v,h]:[v,null]:[h,null];if(k)for(let C=0;C<x;++C)S.push(b=K&&K[C]!==void 0?m[p](H[C],K[C]):m[p](H[C])),b.onerror=T;else for(let C=0;C<x;++C)S.push(b=m[p](H[C])),b.onerror=T}const L=H=>{const K=H.target.result;S.forEach((C,V)=>C.error!=null&&(A[V]=C.error)),g({numFailures:_,failures:A,results:p==="delete"?h:S.map(C=>C.result),lastResult:K})};b.onerror=H=>{T(H),L(H)},b.onsuccess=L})},getMany:({trans:u,keys:p})=>new Promise((h,v)=>{h=F(h);const f=u.objectStore(c),g=p.length,y=new Array(g);let m,w=0,k=0;const x=S=>{const A=S.target;y[A._pos]=A.result,++k===w&&h(y)},b=de(v);for(let S=0;S<g;++S)p[S]!=null&&(m=f.get(p[S]),m._pos=S,m.onsuccess=x,m.onerror=b,++w);w===0&&h(y)}),get:({trans:u,key:p})=>new Promise((h,v)=>{h=F(h);const f=u.objectStore(c).get(p);f.onsuccess=g=>h(g.target.result),f.onerror=de(v)}),query:function(u){return p=>new Promise((h,v)=>{h=F(h);const{trans:f,values:g,limit:y,query:m}=p,w=y===1/0?void 0:y,{index:k,range:x}=m,b=f.objectStore(c),S=k.isPrimaryKey?b:b.index(k.name),A=s(x);if(y===0)return h({result:[]});if(u){const _=g?S.getAll(A,w):S.getAllKeys(A,w);_.onsuccess=T=>h({result:T.target.result}),_.onerror=de(v)}else{let _=0;const T=g||!("openKeyCursor"in S)?S.openCursor(A):S.openKeyCursor(A),L=[];T.onsuccess=H=>{const K=T.result;return K?(L.push(g?K.value:K.primaryKey),++_===y?h({result:L}):void K.continue()):h({result:L})},T.onerror=de(v)}})}(i),openCursor:function({trans:u,values:p,query:h,reverse:v,unique:f}){return new Promise((g,y)=>{g=F(g);const{index:m,range:w}=h,k=u.objectStore(c),x=m.isPrimaryKey?k:k.index(m.name),b=v?f?"prevunique":"prev":f?"nextunique":"next",S=p||!("openKeyCursor"in x)?x.openCursor(s(w),b):x.openKeyCursor(s(w),b);S.onerror=de(y),S.onsuccess=F(A=>{const _=S.result;if(!_)return void g(null);_.___id=++Ti,_.done=!1;const T=_.continue.bind(_);let L=_.continuePrimaryKey;L&&(L=L.bind(_));const H=_.advance.bind(_),K=()=>{throw new Error("Cursor not stopped")};_.trans=u,_.stop=_.continue=_.continuePrimaryKey=_.advance=()=>{throw new Error("Cursor not started")},_.fail=F(y),_.next=function(){let C=1;return this.start(()=>C--?this.continue():this.stop()).then(()=>this)},_.start=C=>{const V=new Promise((U,D)=>{U=F(U),S.onerror=de(D),_.fail=D,_.stop=O=>{_.stop=_.continue=_.continuePrimaryKey=_.advance=K,U(O)}}),Z=()=>{if(S.result)try{C()}catch(U){_.fail(U)}else _.done=!0,_.start=()=>{throw new Error("Cursor behind last entry")},_.stop()};return S.onsuccess=F(U=>{S.onsuccess=Z,Z()}),_.continue=T,_.continuePrimaryKey=L,_.advance=H,Z(),V},g(_)},y)})},count({query:u,trans:p}){const{index:h,range:v}=u;return new Promise((f,g)=>{const y=p.objectStore(c),m=h.isPrimaryKey?y:y.index(h.name),w=s(v),k=w?m.count(w):m.count();k.onsuccess=F(x=>f(x.target.result)),k.onerror=de(g)})}}}(l)),o={};return r.forEach(l=>o[l.name]=l),{stack:"dbcore",transaction:t.transaction.bind(t),table(l){if(!o[l])throw new Error(`Table '${l}' not found`);return o[l]},MIN_KEY:-1/0,MAX_KEY:_t(e),schema:a}}function Un({_novip:t},e){const n=e.db,s=function(a,i,{IDBKeyRange:r,indexedDB:o},l){return{dbcore:function(c,u){return u.reduce((p,{create:h})=>({...p,...h(p)}),c)}(Pi(i,r,l),a.dbcore)}}(t._middlewares,n,t._deps,e);t.core=s.dbcore,t.tables.forEach(a=>{const i=a.name;t.core.schema.tables.some(r=>r.name===i)&&(a.core=t.core.table(i),t[i]instanceof t.Table&&(t[i].core=a.core))})}function on({_novip:t},e,n,s){n.forEach(a=>{const i=s[a];e.forEach(r=>{const o=os(r,a);(!o||"value"in o&&o.value===void 0)&&(r===t.Transaction.prototype||r instanceof t.Transaction?be(r,a,{get(){return this.table(a)},set(l){Qs(this,a,{value:l,writable:!0,configurable:!0,enumerable:!0})}}):r[a]=new t.Table(a,i))})})}function Vn({_novip:t},e){e.forEach(n=>{for(let s in n)n[s]instanceof t.Table&&delete n[s]})}function Ci(t,e){return t._cfg.version-e._cfg.version}function qi(t,e,n,s){const a=t._dbSchema,i=t._createTransaction("readwrite",t._storeNames,a);i.create(n),i._completion.catch(s);const r=i._reject.bind(i),o=M.transless||M;De(()=>{M.trans=i,M.transless=o,e===0?(G(a).forEach(l=>{$n(n,l,a[l].primKey,a[l].indexes)}),Un(t,n),E.follow(()=>t.on.populate.fire(i)).catch(r)):function({_novip:l},d,c,u){const p=[],h=l._versions;let v=l._dbSchema=Yn(l,l.idbdb,u),f=!1;const g=h.filter(m=>m._cfg.version>=d);function y(){return p.length?E.resolve(p.shift()(c.idbtrans)).then(y):E.resolve()}return g.forEach(m=>{p.push(()=>{const w=v,k=m._cfg.dbschema;Jn(l,w,u),Jn(l,k,u),v=l._dbSchema=k;const x=_a(w,k);x.add.forEach(S=>{$n(u,S[0],S[1].primKey,S[1].indexes)}),x.change.forEach(S=>{if(S.recreate)throw new I.Upgrade("Not yet support for changing primary key");{const A=u.objectStore(S.name);S.add.forEach(_=>Wn(A,_)),S.change.forEach(_=>{A.deleteIndex(_.name),Wn(A,_)}),S.del.forEach(_=>A.deleteIndex(_))}});const b=m._cfg.contentUpgrade;if(b&&m._cfg.version>d){Un(l,u),c._memoizedTables={},f=!0;let S=ta(k);x.del.forEach(L=>{S[L]=w[L]}),Vn(l,[l.Transaction.prototype]),on(l,[l.Transaction.prototype],G(S),S),c.schema=S;const A=ls(b);let _;A&&nt();const T=E.follow(()=>{if(_=b(c),_&&A){var L=ke.bind(null,null);_.then(L,L)}});return _&&typeof _.then=="function"?E.resolve(_):T.then(()=>_)}}),p.push(w=>{(!f||!$i)&&function(k,x){[].slice.call(x.db.objectStoreNames).forEach(b=>k[b]==null&&x.db.deleteObjectStore(b))}(m._cfg.dbschema,w),Vn(l,[l.Transaction.prototype]),on(l,[l.Transaction.prototype],l._storeNames,l._dbSchema),c.schema=l._dbSchema})}),y().then(()=>{var m,w;w=u,G(m=v).forEach(k=>{w.db.objectStoreNames.contains(k)||$n(w,k,m[k].primKey,m[k].indexes)})})}(t,e,i,n).catch(r)})}function _a(t,e){const n={del:[],add:[],change:[]};let s;for(s in t)e[s]||n.del.push(s);for(s in e){const a=t[s],i=e[s];if(a){const r={name:s,def:i,recreate:!1,del:[],add:[],change:[]};if(""+(a.primKey.keyPath||"")!=""+(i.primKey.keyPath||"")||a.primKey.auto!==i.primKey.auto&&!pn)r.recreate=!0,n.change.push(r);else{const o=a.idxByName,l=i.idxByName;let d;for(d in o)l[d]||r.del.push(d);for(d in l){const c=o[d],u=l[d];c?c.src!==u.src&&r.change.push(u):r.add.push(u)}(r.del.length>0||r.add.length>0||r.change.length>0)&&n.change.push(r)}}else n.add.push([s,i])}return n}function $n(t,e,n,s){const a=t.db.createObjectStore(e,n.keyPath?{keyPath:n.keyPath,autoIncrement:n.auto}:{autoIncrement:n.auto});return s.forEach(i=>Wn(a,i)),a}function Wn(t,e){t.createIndex(e.name,e.keyPath,{unique:e.unique,multiEntry:e.multi})}function Yn(t,e,n){const s={};return en(e.objectStoreNames,0).forEach(a=>{const i=n.objectStore(a);let r=i.keyPath;const o=Gn(xa(r),r||"",!1,!1,!!i.autoIncrement,r&&typeof r!="string",!0),l=[];for(let c=0;c<i.indexNames.length;++c){const u=i.index(i.indexNames[c]);r=u.keyPath;var d=Gn(u.name,r,!!u.unique,!!u.multiEntry,!1,r&&typeof r!="string",!1);l.push(d)}s[a]=Sa(a,o,l)}),s}function Jn({_novip:t},e,n){const s=n.db.objectStoreNames;for(let a=0;a<s.length;++a){const i=s[a],r=n.objectStore(i);t._hasGetAll="getAll"in r;for(let o=0;o<r.indexNames.length;++o){const l=r.indexNames[o],d=r.index(l).keyPath,c=typeof d=="string"?d:"["+en(d).join("+")+"]";if(e[i]){const u=e[i].idxByName[c];u&&(u.name=l,delete e[i].idxByName[c],e[i].idxByName[l]=u)}}}typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&R.WorkerGlobalScope&&R instanceof R.WorkerGlobalScope&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604&&(t._hasGetAll=!1)}class Bi{_parseStoresSpec(e,n){G(e).forEach(s=>{if(e[s]!==null){var a=e[s].split(",").map((r,o)=>{const l=(r=r.trim()).replace(/([&*]|\+\+)/g,""),d=/^\[/.test(l)?l.match(/^\[(.*)\]$/)[1].split("+"):l;return Gn(l,d||null,/\&/.test(r),/\*/.test(r),/\+\+/.test(r),Y(d),o===0)}),i=a.shift();if(i.multi)throw new I.Schema("Primary key cannot be multi-valued");a.forEach(r=>{if(r.auto)throw new I.Schema("Only primary key can be marked as autoIncrement (++)");if(!r.keyPath)throw new I.Schema("Index must have a name and cannot be an empty string")}),n[s]=Sa(s,i,a)}})}stores(e){const n=this.db;this._cfg.storesSource=this._cfg.storesSource?X(this._cfg.storesSource,e):e;const s=n._versions,a={};let i={};return s.forEach(r=>{X(a,r._cfg.storesSource),i=r._cfg.dbschema={},r._parseStoresSpec(a,i)}),n._dbSchema=i,Vn(n,[n._allTables,n,n.Transaction.prototype]),on(n,[n._allTables,n,n.Transaction.prototype,this._cfg.tables],G(i),i),n._storeNames=G(i),this}upgrade(e){return this._cfg.contentUpgrade=us(this._cfg.contentUpgrade||q,e),this}}function fs(t,e){let n=t._dbNamesDB;return n||(n=t._dbNamesDB=new qe(hn,{addons:[],indexedDB:t,IDBKeyRange:e}),n.version(1).stores({dbnames:"name"})),n.table("dbnames")}function ms(t){return t&&typeof t.databases=="function"}function Qn(t){return De(function(){return M.letThrough=!0,t()})}function Oi(){var t;return!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent)&&indexedDB.databases?new Promise(function(e){var n=function(){return indexedDB.databases().finally(e)};t=setInterval(n,100),n()}).finally(function(){return clearInterval(t)}):Promise.resolve()}function Ri(t){const e=t._state,{indexedDB:n}=t._deps;if(e.isBeingOpened||t.idbdb)return e.dbReadyPromise.then(()=>e.dbOpenError?z(e.dbOpenError):t);pe&&(e.openCanceller._stackHolder=He()),e.isBeingOpened=!0,e.dbOpenError=null,e.openComplete=!1;const s=e.openCanceller;function a(){if(e.openCanceller!==s)throw new I.DatabaseClosed("db.open() was cancelled")}let i=e.dbReadyResolve,r=null,o=!1;const l=()=>new E((d,c)=>{if(a(),!n)throw new I.MissingAPI;const u=t.name,p=e.autoSchema?n.open(u):n.open(u,Math.round(10*t.verno));if(!p)throw new I.MissingAPI;p.onerror=de(c),p.onblocked=F(t._fireOnBlocked),p.onupgradeneeded=F(h=>{if(r=p.transaction,e.autoSchema&&!t._options.allowEmptyDB){p.onerror=xt,r.abort(),p.result.close();const f=n.deleteDatabase(u);f.onsuccess=f.onerror=F(()=>{c(new I.NoSuchDatabase(`Database ${u} doesnt exist`))})}else{r.onerror=de(c);var v=h.oldVersion>Math.pow(2,62)?0:h.oldVersion;o=v<1,t._novip.idbdb=p.result,qi(t,v/10,r,c)}},c),p.onsuccess=F(()=>{r=null;const h=t._novip.idbdb=p.result,v=en(h.objectStoreNames);if(v.length>0)try{const g=h.transaction((f=v).length===1?f[0]:f,"readonly");e.autoSchema?function({_novip:y},m,w){y.verno=m.version/10;const k=y._dbSchema=Yn(0,m,w);y._storeNames=en(m.objectStoreNames,0),on(y,[y._allTables],G(k),k)}(t,h,g):(Jn(t,t._dbSchema,g),function(y,m){const w=_a(Yn(0,y.idbdb,m),y._dbSchema);return!(w.add.length||w.change.some(k=>k.add.length||k.change.length))}(t,g)||console.warn("Dexie SchemaDiff: Schema was extended without increasing the number passed to db.version(). Some queries may fail.")),Un(t,g)}catch{}var f;ft.push(t),h.onversionchange=F(g=>{e.vcFired=!0,t.on("versionchange").fire(g)}),h.onclose=F(g=>{t.on("close").fire(g)}),o&&function({indexedDB:g,IDBKeyRange:y},m){!ms(g)&&m!==hn&&fs(g,y).put({name:m}).catch(q)}(t._deps,u),d()},c)}).catch(d=>d&&d.name==="UnknownError"&&e.PR1398_maxLoop>0?(e.PR1398_maxLoop--,console.warn("Dexie: Workaround for Chrome UnknownError on open()"),l()):E.reject(d));return E.race([s,(typeof navigator>"u"?E.resolve():Oi()).then(l)]).then(()=>(a(),e.onReadyBeingFired=[],E.resolve(Qn(()=>t.on.ready.fire(t.vip))).then(function d(){if(e.onReadyBeingFired.length>0){let c=e.onReadyBeingFired.reduce(us,q);return e.onReadyBeingFired=[],E.resolve(Qn(()=>c(t.vip))).then(d)}}))).finally(()=>{e.onReadyBeingFired=null,e.isBeingOpened=!1}).then(()=>t).catch(d=>{e.dbOpenError=d;try{r&&r.abort()}catch{}return s===e.openCanceller&&t._close(),z(d)}).finally(()=>{e.openComplete=!0,i()})}function Xn(t){var e=i=>t.next(i),n=a(e),s=a(i=>t.throw(i));function a(i){return r=>{var o=i(r),l=o.value;return o.done?l:l&&typeof l.then=="function"?l.then(n,s):Y(l)?Promise.all(l).then(n,s):n(l)}}return a(e)()}function Fi(t,e,n){var s=arguments.length;if(s<2)throw new I.InvalidArgument("Too few arguments");for(var a=new Array(s-1);--s;)a[s-1]=arguments[s];return n=a.pop(),[t,na(a),n]}function $a(t,e,n,s,a){return E.resolve().then(()=>{const i=M.transless||M,r=t._createTransaction(e,n,t._dbSchema,s),o={trans:r,transless:i};if(s)r.idbtrans=s.idbtrans;else try{r.create(),t._state.PR1398_maxLoop=3}catch(u){return u.name===ds.InvalidState&&t.isOpen()&&--t._state.PR1398_maxLoop>0?(console.warn("Dexie: Need to reopen db"),t._close(),t.open().then(()=>$a(t,e,n,null,a))):z(u)}const l=ls(a);let d;l&&nt();const c=E.follow(()=>{if(d=a.call(r,r),d)if(l){var u=ke.bind(null,null);d.then(u,u)}else typeof d.next=="function"&&typeof d.throw=="function"&&(d=Xn(d))},o);return(d&&typeof d.then=="function"?E.resolve(d).then(u=>r.active?u:z(new I.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"))):c.then(()=>d)).then(u=>(s&&r._resolve(),r._completion.then(()=>u))).catch(u=>(r._reject(u),z(u)))})}function Ht(t,e,n){const s=Y(t)?t.slice():[t];for(let a=0;a<n;++a)s.push(e);return s}const Ni={stack:"dbcore",name:"VirtualIndexMiddleware",level:1,create:function(t){return{...t,table(e){const n=t.table(e),{schema:s}=n,a={},i=[];function r(c,u,p){const h=gt(c),v=a[h]=a[h]||[],f=c==null?0:typeof c=="string"?1:c.length,g=u>0,y={...p,isVirtual:g,keyTail:u,keyLength:f,extractKey:zn(c),unique:!g&&p.unique};return v.push(y),y.isPrimaryKey||i.push(y),f>1&&r(f===2?c[0]:c.slice(0,f-1),u+1,p),v.sort((m,w)=>m.keyTail-w.keyTail),y}const o=r(s.primaryKey.keyPath,0,s.primaryKey);a[":id"]=[o];for(const c of s.indexes)r(c.keyPath,0,c);function l(c){const u=c.query.index;return u.isVirtual?{...c,query:{index:u,range:(p=c.query.range,h=u.keyTail,{type:p.type===1?2:p.type,lower:Ht(p.lower,p.lowerOpen?t.MAX_KEY:t.MIN_KEY,h),lowerOpen:!0,upper:Ht(p.upper,p.upperOpen?t.MIN_KEY:t.MAX_KEY,h),upperOpen:!0})}}:c;var p,h}return{...n,schema:{...s,primaryKey:o,indexes:i,getIndexByKeyPath:function(c){const u=a[gt(c)];return u&&u[0]}},count:c=>n.count(l(c)),query:c=>n.query(l(c)),openCursor(c){const{keyTail:u,isVirtual:p,keyLength:h}=c.query.index;return p?n.openCursor(l(c)).then(v=>v&&function(f){return Object.create(f,{continue:{value:function(y){y!=null?f.continue(Ht(y,c.reverse?t.MAX_KEY:t.MIN_KEY,u)):c.unique?f.continue(f.key.slice(0,h).concat(c.reverse?t.MIN_KEY:t.MAX_KEY,u)):f.continue()}},continuePrimaryKey:{value(y,m){f.continuePrimaryKey(Ht(y,t.MAX_KEY,u),m)}},primaryKey:{get:()=>f.primaryKey},key:{get(){const y=f.key;return h===1?y[0]:y.slice(0,h)}},value:{get:()=>f.value}})}(v)):n.openCursor(c)}}}}}};function gs(t,e,n,s){return n=n||{},s=s||"",G(t).forEach(a=>{if(ae(e,a)){var i=t[a],r=e[a];if(typeof i=="object"&&typeof r=="object"&&i&&r){const o=Ln(i);o!==Ln(r)?n[s+a]=e[a]:o==="Object"?gs(i,r,n,s+a+"."):i!==r&&(n[s+a]=e[a])}else i!==r&&(n[s+a]=e[a])}else n[s+a]=void 0}),G(e).forEach(a=>{ae(t,a)||(n[s+a]=e[a])}),n}const Ki={stack:"dbcore",name:"HooksMiddleware",level:2,create:t=>({...t,table(e){const n=t.table(e),{primaryKey:s}=n.schema;return{...n,mutate(i){const r=M.trans,{deleting:o,creating:l,updating:d}=r.table(e).hook;switch(i.type){case"add":if(l.fire===q)break;return r._promise("readwrite",()=>c(i),!0);case"put":if(l.fire===q&&d.fire===q)break;return r._promise("readwrite",()=>c(i),!0);case"delete":if(o.fire===q)break;return r._promise("readwrite",()=>c(i),!0);case"deleteRange":if(o.fire===q)break;return r._promise("readwrite",()=>function(p){return u(p.trans,p.range,1e4)}(i),!0)}return n.mutate(i);function c(p){const h=M.trans,v=p.keys||function(f,g){return g.type==="delete"?g.keys:g.keys||g.values.map(f.extractKey)}(s,p);if(!v)throw new Error("Keys missing");return(p=p.type==="add"||p.type==="put"?{...p,keys:v}:{...p}).type!=="delete"&&(p.values=[...p.values]),p.keys&&(p.keys=[...p.keys]),function(f,g,y){return g.type==="add"?Promise.resolve([]):f.getMany({trans:g.trans,keys:y,cache:"immutable"})}(n,p,v).then(f=>{const g=v.map((y,m)=>{const w=f[m],k={onerror:null,onsuccess:null};if(p.type==="delete")o.fire.call(k,y,w,h);else if(p.type==="add"||w===void 0){const x=l.fire.call(k,y,p.values[m],h);y==null&&x!=null&&(y=x,p.keys[m]=y,s.outbound||le(p.values[m],s.keyPath,y))}else{const x=gs(w,p.values[m]),b=d.fire.call(k,x,y,w,h);if(b){const S=p.values[m];Object.keys(b).forEach(A=>{ae(S,A)?S[A]=b[A]:le(S,A,b[A])})}}return k});return n.mutate(p).then(({failures:y,results:m,numFailures:w,lastResult:k})=>{for(let x=0;x<v.length;++x){const b=m?m[x]:v[x],S=g[x];b==null?S.onerror&&S.onerror(y[x]):S.onsuccess&&S.onsuccess(p.type==="put"&&f[x]?p.values[x]:b)}return{failures:y,results:m,numFailures:w,lastResult:k}}).catch(y=>(g.forEach(m=>m.onerror&&m.onerror(y)),Promise.reject(y)))})}function u(p,h,v){return n.query({trans:p,values:!1,query:{index:s,range:h},limit:v}).then(({result:f})=>c({type:"delete",keys:f,trans:p}).then(g=>g.numFailures>0?Promise.reject(g.failures[0]):f.length<v?{failures:[],numFailures:0,lastResult:void 0}:u(p,{...h,lower:f[f.length-1],lowerOpen:!0},v)))}}}}})};function Ea(t,e,n){try{if(!e||e.keys.length<t.length)return null;const s=[];for(let a=0,i=0;a<e.keys.length&&i<t.length;++a)Q(e.keys[a],t[i])===0&&(s.push(n?Tt(e.values[a]):e.values[a]),++i);return s.length===t.length?s:null}catch{return null}}const Hi={stack:"dbcore",level:-1,create:t=>({table:e=>{const n=t.table(e);return{...n,getMany:s=>{if(!s.cache)return n.getMany(s);const a=Ea(s.keys,s.trans._cache,s.cache==="clone");return a?E.resolve(a):n.getMany(s).then(i=>(s.trans._cache={keys:s.keys,values:s.cache==="clone"?Tt(i):i},i))},mutate:s=>(s.type!=="add"&&(s.trans._cache=null),n.mutate(s))}}})};function vs(t){return!("from"in t)}const fe=function(t,e){if(!this){const n=new fe;return t&&"d"in t&&X(n,t),n}X(this,arguments.length?{d:1,from:t,to:arguments.length>1?e:t}:{d:0})};function $t(t,e,n){const s=Q(e,n);if(isNaN(s))return;if(s>0)throw RangeError();if(vs(t))return X(t,{from:e,to:n,d:1});const a=t.l,i=t.r;if(Q(n,t.from)<0)return a?$t(a,e,n):t.l={from:e,to:n,d:1,l:null,r:null},Hs(t);if(Q(e,t.to)>0)return i?$t(i,e,n):t.r={from:e,to:n,d:1,l:null,r:null},Hs(t);Q(e,t.from)<0&&(t.from=e,t.l=null,t.d=i?i.d+1:1),Q(n,t.to)>0&&(t.to=n,t.r=null,t.d=t.l?t.l.d+1:1);const r=!t.r;a&&!t.l&&ln(t,a),i&&r&&ln(t,i)}function ln(t,e){vs(e)||function n(s,{from:a,to:i,l:r,r:o}){$t(s,a,i),r&&n(s,r),o&&n(s,o)}(t,e)}function Gi(t,e){const n=Zn(e);let s=n.next();if(s.done)return!1;let a=s.value;const i=Zn(t);let r=i.next(a.from),o=r.value;for(;!s.done&&!r.done;){if(Q(o.from,a.to)<=0&&Q(o.to,a.from)>=0)return!0;Q(a.from,o.from)<0?a=(s=n.next(o.from)).value:o=(r=i.next(a.from)).value}return!1}function Zn(t){let e=vs(t)?null:{s:0,n:t};return{next(n){const s=arguments.length>0;for(;e;)switch(e.s){case 0:if(e.s=1,s)for(;e.n.l&&Q(n,e.n.from)<0;)e={up:e,n:e.n.l,s:1};else for(;e.n.l;)e={up:e,n:e.n.l,s:1};case 1:if(e.s=2,!s||Q(n,e.n.to)<=0)return{value:e.n,done:!1};case 2:if(e.n.r){e.s=3,e={up:e,n:e.n.r,s:0};continue}case 3:e=e.up}return{done:!0}}}}function Hs(t){var e,n;const s=(((e=t.r)===null||e===void 0?void 0:e.d)||0)-(((n=t.l)===null||n===void 0?void 0:n.d)||0),a=s>1?"r":s<-1?"l":"";if(a){const i=a==="r"?"l":"r",r={...t},o=t[a];t.from=o.from,t.to=o.to,t[a]=o[a],r[a]=o[i],t[i]=r,r.d=Gs(r)}t.d=Gs(t)}function Gs({r:t,l:e}){return(t?e?Math.max(t.d,e.d):t.d:e?e.d:0)+1}et(fe.prototype,{add(t){return ln(this,t),this},addKey(t){return $t(this,t,t),this},addKeys(t){return t.forEach(e=>$t(this,e,e)),this},[jn](){return Zn(this)}});const zi={stack:"dbcore",level:0,create:t=>{const e=t.schema.name,n=new fe(t.MIN_KEY,t.MAX_KEY);return{...t,table:s=>{const a=t.table(s),{schema:i}=a,{primaryKey:r}=i,{extractKey:o,outbound:l}=r,d={...a,mutate:p=>{const h=p.trans,v=h.mutatedParts||(h.mutatedParts={}),f=b=>{const S=`idb://${e}/${s}/${b}`;return v[S]||(v[S]=new fe)},g=f(""),y=f(":dels"),{type:m}=p;let[w,k]=p.type==="deleteRange"?[p.range]:p.type==="delete"?[p.keys]:p.values.length<50?[[],p.values]:[];const x=p.trans._cache;return a.mutate(p).then(b=>{if(Y(w)){m!=="delete"&&(w=b.results),g.addKeys(w);const S=Ea(w,x);S||m==="add"||y.addKeys(w),(S||k)&&function(A,_,T,L){function H(K){const C=A(K.name||"");function V(U){return U!=null?K.extractKey(U):null}const Z=U=>K.multiEntry&&Y(U)?U.forEach(D=>C.addKey(D)):C.addKey(U);(T||L).forEach((U,D)=>{const O=T&&V(T[D]),it=L&&V(L[D]);Q(O,it)!==0&&(O!=null&&Z(O),it!=null&&Z(it))})}_.indexes.forEach(H)}(f,i,S,k)}else if(w){const S={from:w.lower,to:w.upper};y.add(S),g.add(S)}else g.add(n),y.add(n),i.indexes.forEach(S=>f(S.name).add(n));return b})}},c=({query:{index:p,range:h}})=>{var v,f;return[p,new fe((v=h.lower)!==null&&v!==void 0?v:t.MIN_KEY,(f=h.upper)!==null&&f!==void 0?f:t.MAX_KEY)]},u={get:p=>[r,new fe(p.key)],getMany:p=>[r,new fe().addKeys(p.keys)],count:c,query:c,openCursor:c};return G(u).forEach(p=>{d[p]=function(h){const{subscr:v}=M;if(v){const f=k=>{const x=`idb://${e}/${s}/${k}`;return v[x]||(v[x]=new fe)},g=f(""),y=f(":dels"),[m,w]=u[p](h);if(f(m.name||"").add(w),!m.isPrimaryKey){if(p!=="count"){const k=p==="query"&&l&&h.values&&a.query({...h,values:!1});return a[p].apply(this,arguments).then(x=>{if(p==="query"){if(l&&h.values)return k.then(({result:S})=>(g.addKeys(S),x));const b=h.values?x.result.map(o):x.result;h.values?g.addKeys(b):y.addKeys(b)}else if(p==="openCursor"){const b=x,S=h.values;return b&&Object.create(b,{key:{get:()=>(y.addKey(b.primaryKey),b.key)},primaryKey:{get(){const A=b.primaryKey;return y.addKey(A),A}},value:{get:()=>(S&&g.addKey(b.primaryKey),b.value)}})}return x})}y.add(n)}}return a[p].apply(this,arguments)}}),d}}}};class qe{constructor(e,n){this._middlewares={},this.verno=0;const s=qe.dependencies;this._options=n={addons:qe.addons,autoOpen:!0,indexedDB:s.indexedDB,IDBKeyRange:s.IDBKeyRange,...n},this._deps={indexedDB:n.indexedDB,IDBKeyRange:n.IDBKeyRange};const{addons:a}=n;this._dbSchema={},this._versions=[],this._storeNames=[],this._allTables={},this.idbdb=null,this._novip=this;const i={dbOpenError:null,isBeingOpened:!1,onReadyBeingFired:null,openComplete:!1,dbReadyResolve:q,dbReadyPromise:null,cancelOpen:q,openCanceller:null,autoSchema:!0,PR1398_maxLoop:3};var r;i.dbReadyPromise=new E(o=>{i.dbReadyResolve=o}),i.openCanceller=new E((o,l)=>{i.cancelOpen=l}),this._state=i,this.name=e,this.on=mt(this,"populate","blocked","versionchange","close",{ready:[us,q]}),this.on.ready.subscribe=Xs(this.on.ready.subscribe,o=>(l,d)=>{qe.vip(()=>{const c=this._state;if(c.openComplete)c.dbOpenError||E.resolve().then(l),d&&o(l);else if(c.onReadyBeingFired)c.onReadyBeingFired.push(l),d&&o(l);else{o(l);const u=this;d||o(function p(){u.on.ready.unsubscribe(l),u.on.ready.unsubscribe(p)})}})}),this.Collection=(r=this,rt(Ai.prototype,function(o,l){this.db=r;let d=ba,c=null;if(l)try{d=l()}catch(v){c=v}const u=o._ctx,p=u.table,h=p.hook.reading.fire;this._ctx={table:p,index:u.index,isPrimKey:!u.index||p.schema.primKey.keyPath&&u.index===p.schema.primKey.name,range:d,keysOnly:!1,dir:"next",unique:"",algorithm:null,filter:null,replayFilter:null,justLimit:!0,isMatch:null,offset:0,limit:1/0,error:c,or:u.or,valueMapper:h!==wt?h:null}})),this.Table=function(o){return rt(Di.prototype,function(l,d,c){this.db=o,this._tx=c,this.name=l,this.schema=d,this.hook=o._allTables[l]?o._allTables[l].hook:mt(null,{creating:[fi,q],reading:[yi,wt],updating:[gi,q],deleting:[mi,q]})})}(this),this.Transaction=function(o){return rt(ji.prototype,function(l,d,c,u,p){this.db=o,this.mode=l,this.storeNames=d,this.schema=c,this.chromeTransactionDurability=u,this.idbtrans=null,this.on=mt(this,"complete","error","abort"),this.parent=p||null,this.active=!0,this._reculock=0,this._blockedFuncs=[],this._resolve=null,this._reject=null,this._waitingFor=null,this._waitingQueue=null,this._spinCount=0,this._completion=new E((h,v)=>{this._resolve=h,this._reject=v}),this._completion.then(()=>{this.active=!1,this.on.complete.fire()},h=>{var v=this.active;return this.active=!1,this.on.error.fire(h),this.parent?this.parent._reject(h):v&&this.idbtrans&&this.idbtrans.abort(),z(h)})})}(this),this.Version=function(o){return rt(Bi.prototype,function(l){this.db=o,this._cfg={version:l,storesSource:null,dbschema:{},tables:{},contentUpgrade:null}})}(this),this.WhereClause=function(o){return rt(ka.prototype,function(l,d,c){this.db=o,this._ctx={table:l,index:d===":id"?null:d,or:c};const u=o._deps.indexedDB;if(!u)throw new I.MissingAPI;this._cmp=this._ascending=u.cmp.bind(u),this._descending=(p,h)=>u.cmp(h,p),this._max=(p,h)=>u.cmp(p,h)>0?p:h,this._min=(p,h)=>u.cmp(p,h)<0?p:h,this._IDBKeyRange=o._deps.IDBKeyRange})}(this),this.on("versionchange",o=>{o.newVersion>0?console.warn(`Another connection wants to upgrade database '${this.name}'. Closing db now to resume the upgrade.`):console.warn(`Another connection wants to delete database '${this.name}'. Closing db now to resume the delete request.`),this.close()}),this.on("blocked",o=>{!o.newVersion||o.newVersion<o.oldVersion?console.warn(`Dexie.delete('${this.name}') was blocked`):console.warn(`Upgrade '${this.name}' blocked by other connection holding version ${o.oldVersion/10}`)}),this._maxKey=_t(n.IDBKeyRange),this._createTransaction=(o,l,d,c)=>new this.Transaction(o,l,d,this._options.chromeTransactionDurability,c),this._fireOnBlocked=o=>{this.on("blocked").fire(o),ft.filter(l=>l.name===this.name&&l!==this&&!l._state.vcFired).map(l=>l.on("versionchange").fire(o))},this.use(Ni),this.use(Ki),this.use(zi),this.use(Hi),this.vip=Object.create(this,{_vip:{value:!0}}),a.forEach(o=>o(this))}version(e){if(isNaN(e)||e<.1)throw new I.Type("Given version is not a positive number");if(e=Math.round(10*e)/10,this.idbdb||this._state.isBeingOpened)throw new I.Schema("Cannot add version when database is open");this.verno=Math.max(this.verno,e);const n=this._versions;var s=n.filter(a=>a._cfg.version===e)[0];return s||(s=new this.Version(e),n.push(s),n.sort(Ci),s.stores({}),this._state.autoSchema=!1,s)}_whenReady(e){return this.idbdb&&(this._state.openComplete||M.letThrough||this._vip)?e():new E((n,s)=>{if(this._state.openComplete)return s(new I.DatabaseClosed(this._state.dbOpenError));if(!this._state.isBeingOpened){if(!this._options.autoOpen)return void s(new I.DatabaseClosed);this.open().catch(q)}this._state.dbReadyPromise.then(n,s)}).then(e)}use({stack:e,create:n,level:s,name:a}){a&&this.unuse({stack:e,name:a});const i=this._middlewares[e]||(this._middlewares[e]=[]);return i.push({stack:e,create:n,level:s??10,name:a}),i.sort((r,o)=>r.level-o.level),this}unuse({stack:e,name:n,create:s}){return e&&this._middlewares[e]&&(this._middlewares[e]=this._middlewares[e].filter(a=>s?a.create!==s:!!n&&a.name!==n)),this}open(){return Ri(this)}_close(){const e=this._state,n=ft.indexOf(this);if(n>=0&&ft.splice(n,1),this.idbdb){try{this.idbdb.close()}catch{}this._novip.idbdb=null}e.dbReadyPromise=new E(s=>{e.dbReadyResolve=s}),e.openCanceller=new E((s,a)=>{e.cancelOpen=a})}close(){this._close();const e=this._state;this._options.autoOpen=!1,e.dbOpenError=new I.DatabaseClosed,e.isBeingOpened&&e.cancelOpen(e.dbOpenError)}delete(){const e=arguments.length>0,n=this._state;return new E((s,a)=>{const i=()=>{this.close();var r=this._deps.indexedDB.deleteDatabase(this.name);r.onsuccess=F(()=>{(function({indexedDB:o,IDBKeyRange:l},d){!ms(o)&&d!==hn&&fs(o,l).delete(d).catch(q)})(this._deps,this.name),s()}),r.onerror=de(a),r.onblocked=this._fireOnBlocked};if(e)throw new I.InvalidArgument("Arguments not allowed in db.delete()");n.isBeingOpened?n.dbReadyPromise.then(i):i()})}backendDB(){return this.idbdb}isOpen(){return this.idbdb!==null}hasBeenClosed(){const e=this._state.dbOpenError;return e&&e.name==="DatabaseClosed"}hasFailed(){return this._state.dbOpenError!==null}dynamicallyOpened(){return this._state.autoSchema}get tables(){return G(this._allTables).map(e=>this._allTables[e])}transaction(){const e=Fi.apply(this,arguments);return this._transaction.apply(this,e)}_transaction(e,n,s){let a=M.trans;a&&a.db===this&&e.indexOf("!")===-1||(a=null);const i=e.indexOf("?")!==-1;let r,o;e=e.replace("!","").replace("?","");try{if(o=n.map(d=>{var c=d instanceof this.Table?d.name:d;if(typeof c!="string")throw new TypeError("Invalid table argument to Dexie.transaction(). Only Table or String are allowed");return c}),e=="r"||e===wn)r=wn;else{if(e!="rw"&&e!=kn)throw new I.InvalidArgument("Invalid transaction mode: "+e);r=kn}if(a){if(a.mode===wn&&r===kn){if(!i)throw new I.SubTransaction("Cannot enter a sub-transaction with READWRITE mode when parent transaction is READONLY");a=null}a&&o.forEach(d=>{if(a&&a.storeNames.indexOf(d)===-1){if(!i)throw new I.SubTransaction("Table "+d+" not included in parent transaction.");a=null}}),i&&a&&!a.active&&(a=null)}}catch(d){return a?a._promise(null,(c,u)=>{u(d)}):z(d)}const l=$a.bind(null,this,r,o,a,s);return a?a._promise(r,l,"lock"):M.trans?st(M.transless,()=>this._whenReady(l)):this._whenReady(l)}table(e){if(!ae(this._allTables,e))throw new I.InvalidTable(`Table ${e} does not exist`);return this._allTables[e]}}const Ui=typeof Symbol<"u"&&"observable"in Symbol?Symbol.observable:"@@observable";class Vi{constructor(e){this._subscribe=e}subscribe(e,n,s){return this._subscribe(e&&typeof e!="function"?e:{next:e,error:n,complete:s})}[Ui](){return this}}function Da(t,e){return G(e).forEach(n=>{ln(t[n]||(t[n]=new fe),e[n])}),t}function Wi(t){let e,n=!1;const s=new Vi(a=>{const i=ls(t);let r=!1,o={},l={};const d={get closed(){return r},unsubscribe:()=>{r=!0,Me.storagemutated.unsubscribe(h)}};a.start&&a.start(d);let c=!1,u=!1;function p(){return G(l).some(f=>o[f]&&Gi(o[f],l[f]))}const h=f=>{Da(o,f),p()&&v()},v=()=>{if(c||r)return;o={};const f={},g=function(y){i&&nt();const m=()=>De(t,{subscr:y,trans:null}),w=M.trans?st(M.transless,m):m();return i&&w.then(ke,ke),w}(f);u||(Me(St,h),u=!0),c=!0,Promise.resolve(g).then(y=>{n=!0,e=y,c=!1,r||(p()?v():(o={},l=f,a.next&&a.next(y)))},y=>{c=!1,n=!1,a.error&&a.error(y),d.unsubscribe()})};return v(),d});return s.hasValue=()=>n,s.getValue=()=>e,s}let es;try{es={indexedDB:R.indexedDB||R.mozIndexedDB||R.webkitIndexedDB||R.msIndexedDB,IDBKeyRange:R.IDBKeyRange||R.webkitIDBKeyRange}}catch{es={indexedDB:null,IDBKeyRange:null}}const Ie=qe;function Jt(t){let e=ge;try{ge=!0,Me.storagemutated.fire(t)}finally{ge=e}}et(Ie,{...Gt,delete:t=>new Ie(t,{addons:[]}).delete(),exists:t=>new Ie(t,{addons:[]}).open().then(e=>(e.close(),!0)).catch("NoSuchDatabaseError",()=>!1),getDatabaseNames(t){try{return function({indexedDB:e,IDBKeyRange:n}){return ms(e)?Promise.resolve(e.databases()).then(s=>s.map(a=>a.name).filter(a=>a!==hn)):fs(e,n).toCollection().primaryKeys()}(Ie.dependencies).then(t)}catch{return z(new I.MissingAPI)}},defineClass:()=>function(t){X(this,t)},ignoreTransaction:t=>M.trans?st(M.transless,t):t(),vip:Qn,async:function(t){return function(){try{var e=Xn(t.apply(this,arguments));return e&&typeof e.then=="function"?e:E.resolve(e)}catch(n){return z(n)}}},spawn:function(t,e,n){try{var s=Xn(t.apply(n,e||[]));return s&&typeof s.then=="function"?s:E.resolve(s)}catch(a){return z(a)}},currentTransaction:{get:()=>M.trans||null},waitFor:function(t,e){const n=E.resolve(typeof t=="function"?Ie.ignoreTransaction(t):t).timeout(e||6e4);return M.trans?M.trans.waitFor(n):n},Promise:E,debug:{get:()=>pe,set:t=>{aa(t,t==="dexie"?()=>!0:va)}},derive:Je,extend:X,props:et,override:Xs,Events:mt,on:Me,liveQuery:Wi,extendObservabilitySet:Da,getByKeyPath:we,setByKeyPath:le,delByKeyPath:function(t,e){typeof e=="string"?le(t,e,void 0):"length"in e&&[].map.call(e,function(n){le(t,n,void 0)})},shallowClone:ta,deepClone:Tt,getObjectDiff:gs,cmp:Q,asap:Zs,minKey:Hn,addons:[],connections:ft,errnames:ds,dependencies:es,semVer:Bs,version:Bs.split(".").map(t=>parseInt(t)).reduce((t,e,n)=>t+e/Math.pow(10,2*n))}),Ie.maxKey=_t(Ie.dependencies.IDBKeyRange),typeof dispatchEvent<"u"&&typeof addEventListener<"u"&&(Me(St,t=>{if(!ge){let e;pn?(e=document.createEvent("CustomEvent"),e.initCustomEvent($e,!0,!0,t)):e=new CustomEvent($e,{detail:t}),ge=!0,dispatchEvent(e),ge=!1}}),addEventListener($e,({detail:t})=>{ge||Jt(t)}));let ge=!1;if(typeof BroadcastChannel<"u"){const t=new BroadcastChannel($e);typeof t.unref=="function"&&t.unref(),Me(St,e=>{ge||t.postMessage(e)}),t.onmessage=e=>{e.data&&Jt(e.data)}}else if(typeof self<"u"&&typeof navigator<"u"){Me(St,e=>{try{ge||(typeof localStorage<"u"&&localStorage.setItem($e,JSON.stringify({trig:Math.random(),changedParts:e})),typeof self.clients=="object"&&[...self.clients.matchAll({includeUncontrolled:!0})].forEach(n=>n.postMessage({type:$e,changedParts:e})))}catch{}}),typeof addEventListener<"u"&&addEventListener("storage",e=>{if(e.key===$e){const n=JSON.parse(e.newValue);n&&Jt(n.changedParts)}});const t=self.document&&navigator.serviceWorker;t&&t.addEventListener("message",function({data:e}){e&&e.type===$e&&Jt(e.changedParts)})}E.rejectionMapper=function(t,e){if(!t||t instanceof Qe||t instanceof TypeError||t instanceof SyntaxError||!t.name||!Ts[t.name])return t;var n=new Ts[t.name](e||t.message,t);return"stack"in t&&be(n,"stack",{get:function(){return this.inner.stack}}),n},aa(pe,va);const $=new qe("ApexFocus");$.version(1).stores({tasks:"++id, status, context, goalId, createdAt, dueDate",focus_sessions:"++id, taskId, goalId, startedAt, date, context",time_blocks:"++id, taskId, date, startTime",settings:"key",sync_log:"++id, syncedAt, module"});$.version(2).stores({tasks:"++id, status, context, subjectId, goalId, createdAt, dueDate",focus_sessions:"++id, taskId, goalId, subjectId, startedAt, date, context",time_blocks:"++id, taskId, date, startTime",settings:"key",sync_log:"++id, syncedAt, module",subjects:"++id, name, createdAt"});$.on("ready",async()=>{var n;if(await $.subjects.count()===0){const s=Date.now();await $.subjects.bulkAdd([{name:"Engineering Math",color:"#7F77DD",icon:"∑",dailyGoalMins:60,createdAt:s,order:0},{name:"Engineering Sci A",color:"#D85A30",icon:"⚙",dailyGoalMins:90,createdAt:s,order:1},{name:"Engineering Sci B",color:"#1D9E75",icon:"⚡",dailyGoalMins:60,createdAt:s,order:2},{name:"Field Methods",color:"#BA7517",icon:"🗺",dailyGoalMins:45,createdAt:s,order:3}])}const e=await $.settings.get("main");if(!e)await $.settings.put({key:"main",defaultDuration:50,breakLength:10,longBreakAfter:4,longBreakLength:30,showCountdownRing:!0,autoStartBreak:!1,autoStartNextSession:!1,dailyGoalHours:4,activeDays:[1,2,3,4,5],streakFreezeEnabled:!1,streakGraceDays:1,contexts:[{id:"study",label:"Study",color:"#7F77DD",isStudy:!0},{id:"civil",label:"Civil eng",color:"#BA7517",isStudy:!0},{id:"personal",label:"Personal",color:"#D4537E",isStudy:!1},{id:"trading",label:"Trading",color:"#1D9E75",isStudy:!1}],accentColor:"#7F77DD",theme:"dark",sessionEndSound:!0,breakEndReminder:!0,dailyGoalAlert:!0,morningReminderEnabled:!0,morningReminderTime:"08:30",syncStudy:!0,syncHabits:!0,syncGoals:!0,syncMood:!1,aiProvider:"gemini",aiApiKey:"",aiMorningPrioritisation:!0,aiWeeklyReview:!0,aiDistractionAlerts:!0,aiSmartRescheduling:!1});else{const s={};"theme"in e||(s.theme="dark"),e.contexts&&!((n=e.contexts[0])!=null&&n.hasOwnProperty("isStudy"))&&(s.contexts=e.contexts.map(a=>({...a,isStudy:a.isStudy??(a.id==="study"||a.id==="civil")}))),Object.keys(s).length>0&&await $.settings.put({...e,...s,key:"main"})}});async function te(){return $.settings.get("main")}async function Yi(t){const e=await $.settings.get("main");await $.settings.put({...e,...t,key:"main"})}async function oe(){return(await $.subjects.toArray()).sort((e,n)=>(e.order??99)-(n.order??99)||e.name.localeCompare(n.name))}async function Ji(t){const e=await $.subjects.count(),n=await $.subjects.add({color:"#7F77DD",icon:"📚",dailyGoalMins:60,createdAt:Date.now(),order:e,...t});return ie(()=>Promise.resolve().then(()=>ze),void 0).then(s=>s.syncSubject(n)).catch(()=>{}),n}async function Qt(t,e){const n=await $.subjects.update(t,e);return ie(()=>Promise.resolve().then(()=>ze),void 0).then(s=>s.syncSubject(t)).catch(()=>{}),n}async function Qi(t){return await $.tasks.where("subjectId").equals(t).modify({subjectId:null}),ie(()=>Promise.resolve().then(()=>ze),void 0).then(e=>e.syncDeleteSubject(t)).catch(()=>{}),$.subjects.delete(t)}async function Et(t){return $.focus_sessions.where("date").equals(t).toArray()}async function Ke(t,e){return $.focus_sessions.where("date").between(t,e,!0,!0).sortBy("startedAt")}async function Xi(t){const e=await $.focus_sessions.add({...t,date:new Date(t.startedAt).toISOString().slice(0,10)});return ie(()=>Promise.resolve().then(()=>ze),void 0).then(n=>n.syncSession(e)).catch(()=>{}),e}async function cn(t){return(await Et(t)).reduce((n,s)=>n+(s.durationMins||0),0)}async function tt(t,e){return(await Et(t)).filter(s=>s.subjectId===e).reduce((s,a)=>s+(a.durationMins||0),0)}async function Aa(t,e,n=0){let s=0,a=0;const i=new Date;for(let r=0;r<365;r++){const o=new Date(i);if(o.setDate(o.getDate()-r),!t.includes(o.getDay()))continue;const l=o.toISOString().slice(0,10);if(await cn(l)>=e)s++,a=0;else if(r!==0)if(a<n)a++;else break}return s}async function bs(t,e,n,s=0){let a=0,i=0,r=0,o=0,l=!1;const d=new Date;for(let c=0;c<365;c++){const u=new Date(d);if(u.setDate(u.getDate()-c),!n.includes(u.getDay()))continue;const p=u.toISOString().slice(0,10);if(await tt(p,t)>=e)r++,o=0,i=Math.max(i,r),l||(a=r);else if(c!==0)if(o<s)o++;else{l=!0,r=0;break}}return{current:a,best:i}}$.version(3).stores({tasks:"++id, status, context, subjectId, goalId, createdAt, dueDate",focus_sessions:"++id, taskId, goalId, subjectId, startedAt, date, context",time_blocks:"++id, taskId, date, startTime",settings:"key",sync_log:"++id, syncedAt, module",subjects:"++id, name, createdAt",planned_sessions:"++id, subjectId, date, createdAt"});$.version(4).stores({tasks:"++id, status, context, subjectId, goalId, createdAt, dueDate",focus_sessions:"++id, taskId, goalId, subjectId, startedAt, date, context",time_blocks:"++id, taskId, date, startTime",settings:"key",sync_log:"++id, syncedAt, module",subjects:"++id, name, createdAt",planned_sessions:"++id, subjectId, taskId, date, createdAt",recurring_sessions:"++id, subjectId, createdAt"});async function Zi(t){return $.planned_sessions.where("date").equals(t).toArray()}async function ws(t,e){return $.planned_sessions.where("date").between(t,e,!0,!0).toArray()}async function Ma(t){const e=await $.planned_sessions.add({...t,createdAt:Date.now()});return ie(()=>Promise.resolve().then(()=>ze),void 0).then(n=>n.syncPlanned(e)).catch(()=>{}),e}async function er(t){return ie(()=>Promise.resolve().then(()=>ze),void 0).then(e=>e.syncDeletePlanned(t)).catch(()=>{}),$.planned_sessions.delete(t)}async function tr(t,e){var l;const n=await $.recurring_sessions.where("active").equals(1).toArray().catch(()=>$.recurring_sessions.toArray().then(d=>d.filter(c=>c.active)));if(!n.length)return;const s=await ws(t,e),a=(d,c,u)=>`${d}|${c}|${u}`,i=new Set(s.map(d=>a(d.date,d.subjectId,d.startTime))),r=new Date(t+"T00:00:00"),o=new Date(e+"T00:00:00");for(let d=new Date(r);d<=o;d.setDate(d.getDate()+1)){const c=d.getDay(),u=d.toISOString().slice(0,10);for(const p of n){if(!((l=p.days)!=null&&l.includes(c)))continue;const h=a(u,p.subjectId,p.startTime);i.has(h)||(await Ma({subjectId:p.subjectId,taskId:p.taskId||null,date:u,startTime:p.startTime,durationMins:p.durationMins,notes:p.notes||"",fromRecurring:p.id}),i.add(h))}}}const nr="https://xiaatddlhvasqzzfveli.supabase.co",zs="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhpYWF0ZGRsaHZhc3F6emZ2ZWxpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzU2OTEzODgsImV4cCI6MjA5MTI2NzM4OH0.-a1XP-z6kzOBUJcGGNs8UiNFFx7F8dYsqom9XVR631U";let En=null;function he(){if(En)return En;let t=localStorage.getItem("apex_user_id");return t||(t="user_"+crypto.randomUUID(),localStorage.setItem("apex_user_id",t)),En=t,t}function sr(){return{"Content-Type":"application/json",apikey:zs,Authorization:"Bearer "+zs,Prefer:"resolution=merge-duplicates,return=minimal"}}async function at(t,e={}){const n=await fetch(nr+"/rest/v1"+t,{...e,headers:{...sr(),...e.headers||{}}});if(!n.ok){const a=await n.text().catch(()=>"");throw new Error(`Supabase ${e.method||"GET"} ${t} → ${n.status}: ${a}`)}const s=await n.text();return s?JSON.parse(s):null}async function Ge(){try{const t=await $.settings.get("syncQueue");return t!=null&&t.value?JSON.parse(t.value):[]}catch{return[]}}async function Ia(t){await $.settings.put({key:"syncQueue",value:JSON.stringify(t)})}async function ne(t){const e=await Ge(),n=e.findIndex(s=>s.table===t.table&&s.localId===t.localId);n>=0?e[n]=t:e.push(t),await Ia(e)}let La="idle",Xt=[],ks=0;function ja(t){return Xt.push(t),t(La,ks),()=>{Xt=Xt.filter(e=>e!==t)}}function ee(t,e=0){La=t,ks=e,Xt.forEach(n=>n(t,e))}let ce=navigator.onLine;window.addEventListener("online",()=>{ce=!0,Dt()});window.addEventListener("offline",()=>{ce=!1,ee("offline",ks)});async function Ta(t){const e=await $.settings.get("idMap_"+t).catch(()=>null);return e!=null&&e.value?JSON.parse(e.value):{}}async function ar(t,e){await $.settings.put({key:"idMap_"+t,value:JSON.stringify(e)})}async function xs(t,e){return(await Ta(t))[e]||null}async function ir(t,e,n){const s=await Ta(t);s[e]=n,await ar(t,s)}async function Ss(t){return{local_id:t.id,name:t.name,color:t.color||"#7F77DD",icon:t.icon||"",daily_goal_mins:t.dailyGoalMins||60,order:t.order??0,created_at:t.createdAt||Date.now(),updated_at:Date.now(),deleted:!1,user_id:he()}}async function _s(t){let e=null;return t.subjectId&&(e=await xs("subjects",t.subjectId)),{local_id:t.id,title:t.title,context:t.context||null,subject_id:e,priority:t.priority||3,status:t.status||"inbox",estimated_mins:t.estimatedMins||null,due_date:t.dueDate||null,due_time:t.dueTime||null,notes:t.notes||null,completed_at:t.completedAt||null,created_at:t.createdAt||Date.now(),updated_at:Date.now(),deleted:!1,user_id:he()}}async function $s(t){let e=null;return t.subjectId&&(e=await xs("subjects",t.subjectId)),{local_id:t.id,subject_id:e,task_id:t.taskId||null,context:t.context||null,started_at:t.startedAt,duration_mins:t.durationMins||0,distractions:t.distractions||0,distraction_log:t.distractionLog?JSON.stringify(t.distractionLog):null,quality_rating:t.qualityRating||null,notes:t.notes||null,date:t.date,created_at:t.startedAt||Date.now(),updated_at:Date.now(),deleted:!1,user_id:he()}}async function Es(t){let e=null;return t.subjectId&&(e=await xs("subjects",t.subjectId)),{local_id:t.id,subject_id:e,date:t.date,start_time:t.startTime||null,duration_mins:t.durationMins||50,notes:t.notes||null,created_at:t.createdAt||Date.now(),updated_at:Date.now(),deleted:!1,user_id:he()}}async function re(t,e){await at("/"+t+"?on_conflict=local_id,user_id",{method:"POST",headers:{Prefer:"resolution=merge-duplicates,return=representation"},body:JSON.stringify(e)})}async function rr(t){try{const e=await $.subjects.get(t);if(!e)return;const n=await Ss(e);ce?(await re("subjects",n),await ir("subjects",t,n.local_id),xe()):(await ne({table:"subjects",localId:t,type:"upsert"}),ee("offline",(await Ge()).length))}catch(e){console.warn("[Sync] subject failed:",e),await ne({table:"subjects",localId:t,type:"upsert"})}}async function yn(t){try{const e=await $.tasks.get(t);if(!e)return;const n=await _s(e);ce?(await re("tasks",n),xe()):(await ne({table:"tasks",localId:t,type:"upsert"}),ee("offline",(await Ge()).length))}catch(e){console.warn("[Sync] task failed:",e),await ne({table:"tasks",localId:t,type:"upsert"})}}async function or(t){try{const e=await $.focus_sessions.get(t);if(!e)return;const n=await $s(e);ce?(await re("focus_sessions",n),xe()):(await ne({table:"focus_sessions",localId:t,type:"upsert"}),ee("offline",(await Ge()).length))}catch(e){console.warn("[Sync] session failed:",e),await ne({table:"focus_sessions",localId:t,type:"upsert"})}}async function lr(t){try{const e=await $.planned_sessions.get(t);if(!e)return;const n=await Es(e);ce?(await re("planned_sessions",n),xe()):(await ne({table:"planned_sessions",localId:t,type:"upsert"}),ee("offline",(await Ge()).length))}catch(e){console.warn("[Sync] planned failed:",e),await ne({table:"planned_sessions",localId:t,type:"upsert"})}}async function cr(t){try{ce?(await at(`/subjects?local_id=eq.${t}&user_id=eq.${he()}`,{method:"PATCH",body:JSON.stringify({deleted:!0,updated_at:Date.now()})}),xe()):await ne({table:"subjects",localId:t,type:"delete"})}catch(e){console.warn("[Sync] delete subject failed:",e),await ne({table:"subjects",localId:t,type:"delete"})}}async function Ds(t){try{ce?(await at(`/tasks?local_id=eq.${t}&user_id=eq.${he()}`,{method:"PATCH",body:JSON.stringify({deleted:!0,updated_at:Date.now()})}),xe()):await ne({table:"tasks",localId:t,type:"delete"})}catch{await ne({table:"tasks",localId:t,type:"delete"})}}async function dr(t){try{ce?(await at(`/planned_sessions?local_id=eq.${t}&user_id=eq.${he()}`,{method:"PATCH",body:JSON.stringify({deleted:!0,updated_at:Date.now()})}),xe()):await ne({table:"planned_sessions",localId:t,type:"delete"})}catch{await ne({table:"planned_sessions",localId:t,type:"delete"})}}async function Dt(){const t=await Ge();if(t.length===0){ee("synced",0);return}ee("syncing",t.length);const e=[];for(const n of t)try{if(n.type==="upsert"){if(n.table==="subjects"){const s=await $.subjects.get(n.localId);s&&await re("subjects",await Ss(s))}else if(n.table==="tasks"){const s=await $.tasks.get(n.localId);s&&await re("tasks",await _s(s))}else if(n.table==="focus_sessions"){const s=await $.focus_sessions.get(n.localId);s&&await re("focus_sessions",await $s(s))}else if(n.table==="planned_sessions"){const s=await $.planned_sessions.get(n.localId);s&&await re("planned_sessions",await Es(s))}}else n.type==="delete"&&await at(`/${n.table}?local_id=eq.${n.localId}&user_id=eq.${he()}`,{method:"PATCH",body:JSON.stringify({deleted:!0,updated_at:Date.now()})})}catch(s){console.warn("[Sync] flush failed for",n,s),e.push(n)}await Ia(e),e.length===0?(xe(),ee("synced",0)):ee("error",e.length)}async function Pa(){if(!ce){ee("offline",(await Ge()).length);return}ee("syncing",0);try{const[t,e,n,s]=await Promise.all([$.subjects.toArray(),$.tasks.toArray(),$.focus_sessions.toArray(),$.planned_sessions.toArray()]);for(const i of t)await re("subjects",await Ss(i));for(const i of e)await re("tasks",await _s(i));for(const i of n)await re("focus_sessions",await $s(i));for(const i of s)await re("planned_sessions",await Es(i));const a=await $.settings.get("main");a&&await at("/settings?on_conflict=user_id",{method:"POST",headers:{Prefer:"resolution=merge-duplicates,return=minimal"},body:JSON.stringify({user_id:he(),data:JSON.stringify(a),updated_at:Date.now()})}),await Dt(),xe(),ee("synced",0)}catch(t){console.warn("[Sync] initial sync error:",t),ee("error",0)}}async function xe(){const t=Date.now();await $.settings.put({key:"lastSupabaseSync",value:t}),ee("synced",0)}async function ur(){const t=await $.settings.get("lastSupabaseSync").catch(()=>null);return(t==null?void 0:t.value)||null}function Ca(){Dt(),setInterval(()=>{ce&&Dt()},6e4)}const ze=Object.freeze(Object.defineProperty({__proto__:null,flushQueue:Dt,getLastSyncTime:ur,getUserId:he,initialSync:Pa,onSyncStatus:ja,startAutoSync:Ca,syncDeletePlanned:dr,syncDeleteSubject:cr,syncDeleteTask:Ds,syncPlanned:lr,syncSession:or,syncSubject:rr,syncTask:yn},Symbol.toStringTag,{value:"Module"}));function N(){const t=new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`}function As(t){const e=new Date(t);return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function qa(t){return new Date(t).toLocaleDateString("en-GB",{weekday:"long",day:"numeric",month:"long"})}function Ze(t){const e=Math.floor(Math.max(0,t)/60),n=Math.max(0,t)%60;return`${String(e).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function B(t){const e=Math.floor(t/60),n=t%60;return e===0?`${n}m`:n===0?`${e}h`:`${e}h ${n}m`}function Be(t){return(t/60).toFixed(1)+"h"}function At(t){return t===0?"12am":t<12?`${t}am`:t===12?"12pm":`${t-12}pm`}function j(t=""){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ba(t,e,n=80){let s=null,a=null;t.addEventListener("touchstart",i=>{s=i.touches[0].clientX,a=i.touches[0].clientY},{passive:!0}),t.addEventListener("touchend",i=>{if(s===null)return;const r=i.changedTouches[0].clientX-s,o=Math.abs(i.changedTouches[0].clientY-a);r<-n&&o<40&&e(),s=null},{passive:!0})}function Oa(t,e,n=80){let s=null,a=null;t.addEventListener("touchstart",i=>{s=i.touches[0].clientX,a=i.touches[0].clientY},{passive:!0}),t.addEventListener("touchend",i=>{if(s===null)return;const r=i.changedTouches[0].clientX-s,o=Math.abs(i.changedTouches[0].clientY-a);r>n&&o<40&&e(),s=null},{passive:!0})}async function Mt(t,e){var n,s,a,i,r,o;if(!e)return null;try{const l=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:t}]}],generationConfig:{maxOutputTokens:512,temperature:.7}})});if(!l.ok)throw new Error(`Gemini ${l.status}`);return((o=(r=(i=(a=(s=(n=(await l.json()).candidates)==null?void 0:n[0])==null?void 0:s.content)==null?void 0:a.parts)==null?void 0:i[0])==null?void 0:r.text)==null?void 0:o.trim())??null}catch(l){return console.warn("Gemini call failed:",l.message),null}}function Ra(t,e){const n=e.slice(-20).map(a=>a.context);return`You are a productivity assistant. Given these tasks and recent focus history, 
...
Reply with only the suggestion text, no preamble.`}const Ka=Object.freeze(Object.defineProperty({__proto__:null,buildDistractionPrompt:Na,buildMorningPrompt:Ra,buildWeeklySummaryPrompt:Fa,callGemini:Mt,dateStr:As,dayLabel:qa,esc:j,fmtHours:Be,fmtMins:B,fmtTime:Ze,hourLabel:At,onSwipeLeft:Ba,onSwipeRight:Oa,todayStr:N},Symbol.toStringTag,{value:"Module"}));let Oe="all",ve="active",ut="priority",ts=null;async function pr(t){const[e,n]=await Promise.all([te(),oe()]);t.innerHTML=`
  ...
  `;async function s(){const[a,i,r]=await Promise.all([$.tasks.toArray(),te(),oe()]);Ha(a,i,r),Ua(a)}t.querySelector("#ctx-filters").addEventListener("click",a=>{const i=a.target.closest(".ctx-pill");i&&(Oe=i.dataset.ctx,ts=null,t.querySelectorAll(".ctx-pill").forEach(r=>r.classList.remove("active")),i.classList.add("active"),s())}),t.querySelectorAll(".filter-tab").forEach(a=>{a.addEventListener("click",()=>{ve=a.dataset.filter,t.querySelectorAll(".filter-tab").forEach(i=>i.classList.remove("active")),a.classList.add("active"),s()})}),t.querySelector("#sort-select").addEventListener("change",a=>{ut=a.target.value,s()}),t.querySelector("#add-task-btn").addEventListener("click",()=>{yr(s)}),t.querySelector("#plan-btn").addEventListener("click",()=>{ie(()=>Promise.resolve().then(()=>vn),void 0).then(a=>a.navigateTo("focus"))}),s()}function Ha(t,e,n){const s=document.getElementById("task-list");if(!s)return;let a=Oe==="all"?t:t.filter(l=>l.context===Oe);ts&&(a=a.filter(l=>l.subjectId===ts));const i=a.filter(l=>!l.completedAt),r=a.filter(l=>!!l.completedAt);let o=[];if(ve==="today"?o=i.filter(l=>l.status==="today"):ve==="done"?o=r:o=i,o=hr(o,ut),s.innerHTML="",o.length===0){s.appendChild(gr(ve));return}if(ve==="active"){const l=o.filter(c=>c.status==="today"),d=o.filter(c=>c.status!=="today");l.length>0&&(s.insertAdjacentHTML("beforeend",Us("Today",l.length)),l.forEach(c=>s.appendChild(Dn(c,e,n)))),d.length>0&&(s.insertAdjacentHTML("beforeend",Us("Backlog",d.length)),d.forEach(c=>s.appendChild(Dn(c,e,n))))}else o.forEach(l=>s.appendChild(Dn(l,e,n)))}function hr(t,e){return[...t].sort((n,s)=>{if(e==="due")return!n.dueDate&&!s.dueDate?(n.priority||3)-(s.priority||3):n.dueDate?s.dueDate?new Date(n.dueDate)-new Date(s.dueDate):-1:1;if(e==="created")return(s.createdAt||0)-(n.createdAt||0);const a=(n.priority||3)-(s.priority||3);return a!==0?a:(n.createdAt||0)-(s.createdAt||0)})}function Dn(t,e,n){const s=e.contexts.find(h=>h.id===t.context),a=t.subjectId?n.find(h=>h.id===t.subjectId):null,i=(s==null?void 0:s.color)||"#888",r=(s==null?void 0:s.label)||t.context,o=!!t.completedAt,d={1:"var(--coral)",2:"var(--amber)",3:"var(--text-muted)"}[t.priority]||"var(--text-muted)",c=document.createElement("div");c.className="task-row-wrap",c.dataset.id=t.id,c.innerHTML=`
  ...
  `,s}async function ns(t){const e=await $.tasks.get(t);e&&(await $.tasks.update(t,{completedAt:e.completedAt?null:Date.now(),status:e.completedAt?"inbox":e.status}),yn(t).catch(()=>{}),It())}async function It(){const[t,e,n]=await Promise.all([$.tasks.toArray(),te(),oe()]);Ha(t,e,n),Ua(t)}function Ua(t){const e=document.getElementById("task-count");if(!e)return;const n=t.filter(i=>!i.completedAt),s=t.filter(i=>!!i.completedAt),a=n.reduce((i,r)=>i+(r.estimatedMins||0),0);e.textContent=`${n.length} active${a>0?" · "+B(a):""} · ${s.length} done`}function Us(t,e){return`<div class="section-header">${t}<span class="section-count">${e}</span></div>`}function Vs(t){return new Promise(e=>setTimeout(e,t))}let vt=null,Zt=null,P={},Te=0;async function vr(t){Ms=t;const[e,n]=await Promise.all([te(),oe()]),s=await Is();if(t.innerHTML=`
    <div class="view-header">
      <h1 class="view-title">Focus</h1>
      <span class="state-badge" id="state-badge">Idle</span>
    </div>
    <div id="session-stage"></div>
  `,vt&&P.taskId){const a=await $.tasks.get(P.taskId),i=e.contexts.find(c=>c.id===(a==null?void 0:a.context)),r=P.subjectId?n.find(c=>c.id===P.subjectId):null,o=(P.durationMins||e.defaultDuration)*60,l=Math.floor((Date.now()-P.startedAt)/1e3),d=Math.max(0,o-l);mn(t,a,i,r,P.durationMins,e,d)}else fn(t,s,e,n)}async function br(t){return Ms=t,vr(t)}let Ms=null;async function fn(t,e,n,s){var l,d;Re(),Lt("Idle","");const a=t.querySelector("#session-stage");a.innerHTML=`
  ...
  `}function mn(t,e,n,s,a,i,r){Re(),Lt("Focus","focus");const o=(s==null?void 0:s.color)||(n==null?void 0:n.color)||"#7F77DD",l=(a||i.defaultDuration)*60,d=2*Math.PI*68,c=r!==void 0,u=P;P={taskId:(e==null?void 0:e.id)||null,goalId:(e==null?void 0:e.goalId)||null,context:(e==null?void 0:e.context)||null,subjectId:(s==null?void 0:s.id)||null,startedAt:c?u.startedAt:Date.now(),durationMins:a||i.defaultDuration,totalSecs:l,distractions:c&&u.distractions||0,distractionLog:c?u.distractionLog||[]:[],qualityRating:c?u.qualityRating:null,notes:c&&u.notes||""};const p=t.querySelector("#session-stage"),h=s?`${s.icon?s.icon+" ":""}${s.name}`:e?e.title:"Free session";if(p.innerHTML=`
    <div class="active-header">
      <div class="task-pill" style="border-color:${o}44">
        <span class="ctx-dot" style="background:${o}"></span>
        <span class="pill-text">${j(h)}</span>
      </div>
      ${e&&e.title!==h?`
      ...
      <div class="pomo-dots" id="pomo-dots">
        ${Array.from({length:i.longBreakAfter||4},(x,b)=>`
          <div class="pomo-dot ${b<Te?"done":b===Te?"active":""}"></div>
        `).join("")}
      </div>
    </div>
  ...
  `,s&&ss(s),c&&P.distractions>0){const x=document.getElementById("distract-badge");x&&(x.textContent=P.distractions)}let v=r!==void 0?r:l,f=!1;const g=v/l,y=(d*(1-g)).toFixed(1),m=document.getElementById("ring-fg");m&&m.setAttribute("stroke-dashoffset",y);const w=document.getElementById("timer-num");w&&(w.textContent=Ze(Math.max(0,v))),vt=setInterval(()=>{var _,T,L;if(f)return;v--;const x=document.getElementById("timer-num");x&&(x.textContent=Ze(Math.max(0,v)));const b=v/l,S=(d*(1-b)).toFixed(1),A=document.getElementById("ring-fg");A&&A.setAttribute("stroke-dashoffset",S),s&&(l-v)%30===0&&ss(s),v<=0&&(Re(),Te++,(_=window._apexHaptic)==null||_.call(window,"medium"),i.sessionEndSound&&((T=window._apexPlayBeep)==null||T.call(window,"session-end")),(L=window._apexNotify)==null||L.call(window,"Session complete — Apex Focus",`${P.durationMins}m logged. Rate your session.`),Ws(t,e,n,s,i))},1e3);const k=p.querySelector("#pause-btn");k.addEventListener("click",()=>{f=!f,k.textContent=f?"Resume":"Pause",Lt(f?"Paused":"Focus",f?"":"focus")}),p.querySelector("#end-btn").addEventListener("click",()=>{Re();const x=Math.max(1,Math.round((Date.now()-P.startedAt)/6e4));P.durationMins=x,Te++,Ws(t,e,n,s,i)}),p.querySelectorAll(".distract-chip").forEach(x=>{x.addEventListener("click",()=>{P.distractions++,P.distractionLog.push({type:x.dataset.type,at:Date.now()});const b=document.getElementById("distract-badge");b&&(b.textContent=P.distractions),x.classList.add("logged"),setTimeout(()=>x.classList.remove("logged"),900)})}),"wakeLock"in navigator&&navigator.wakeLock.request("screen").catch(()=>{})}async function ss(t,e){const n=document.getElementById("active-subj-progress");if(!n)return;const s=await tt(N(),t.id),a=Math.min(100,Math.round(s/(t.dailyGoalMins||60)*100));n.innerHTML=`
  ...
  `}async function Ws(t,e,n,s,a){let i=null;if(a.aiDistractionAlerts&&a.aiApiKey&&P.distractions>0){const r=await Et(N()),o=r.length?r.reduce((l,d)=>l+(d.distractions||0),0)/r.length:0;P.distractions>o*1.5+1&&(i=await Mt(Na(P,o),a.aiApiKey).catch(()=>null))}if(a.aiSmartRescheduling&&a.aiApiKey)try{const r=new Date,o=r.getHours()*60+r.getMinutes(),l=await $.time_blocks.where("date").equals(N()).filter(d=>d.startTime>o).toArray();if(l.length>0&&!i){const d=[...new Set(l.map(h=>h.taskId).filter(Boolean))],u=(await Promise.all(d.map(h=>$.tasks.get(h)))).filter(Boolean).map(h=>h.title),p=`You are a productivity assistant. A focus session just ended and it's now ${r.getHours()}:${String(r.getMinutes()).padStart(2,"0")}. The user still has these tasks planned: ${u.join(", ")}. In one short sentence (under 15 words), suggest whether to continue the plan or drop the lowest priority task. Be direct.`;i=await Mt(p,a.aiApiKey).catch(()=>null)}}catch{}xr(t,e,n,s,a,i)}function xr(t,e,n,s,a,i=null){Lt("Done","done");const r=t.querySelector("#session-stage"),o=P.distractions>0?Math.max(0,Math.round(100-P.distractions/P.durationMins*100*.5)):100;r.innerHTML=`
    <div class="wrap-hero">
      <div class="wrap-icon">
  ...
  `,s&&ss(s).then(()=>{tt(N(),s.id).then(l=>{if(l+P.durationMins>=s.dailyGoalMins&&l<s.dailyGoalMins){const d=document.getElementById("wrap-subj-progress");d&&d.insertAdjacentHTML("beforeend",`
            <p class="dp-done" style="color:${s.color};margin-top:4px">
              ${s.name} goal reached 🎉
            </p>
          `)}})}),r.querySelector("#session-note").addEventListener("input",l=>{P.notes=l.target.value}),r.querySelectorAll("#quality-seg .seg-btn").forEach(l=>{l.addEventListener("click",()=>{r.querySelectorAll("#quality-seg .seg-btn").forEach(c=>{c.classList.remove("seg-active"),c.style.cssText=""}),l.classList.add("seg-active"),l.style.background="var(--accent)22",l.style.borderColor="var(--accent)",l.style.color="var(--accent)",P.qualityRating=l.dataset.val;const d=document.getElementById("quality-stat");d&&(d.textContent=l.dataset.val)})}),r.querySelector("#save-btn").addEventListener("click",async()=>{await Js(a,s);const[l,d]=await Promise.all([Is(),oe()]);fn(t,l,a,d)}),r.querySelector("#break-btn").addEventListener("click",async()=>{await Js(a,s);const l=Te>0&&Te%(a.longBreakAfter||4)===0;l&&(Te=0),Sr(t,l?a.longBreakLength:a.breakLength,a)})}function Sr(t,e,n){Re(),Lt("Break","break");const s=e*60;let a=s;const i=2*Math.PI*68,r=t.querySelector("#session-stage");r.innerHTML=`
  ...
  `,Zt=setInterval(()=>{var d;a--;const o=document.getElementById("break-num"),l=document.getElementById("break-ring");o&&(o.textContent=Ze(Math.max(0,a))),l&&l.setAttribute("stroke-dashoffset",(i*(1-a/s)).toFixed(1)),a<=0&&(Re(),n.breakEndReminder&&((d=window._apexPlayBeep)==null||d.call(window,"break-end")),Ys(t,n))},1e3),r.querySelector("#skip-break").addEventListener("click",()=>{Re(),Ys(t,n)})}async function Ys(t,e){const[n,s]=await Promise.all([Is(),oe()]);fn(t,n,e,s)}async function _r(t,e,n,s){const a=await $.time_blocks.where("date").equals(N()).toArray(),i=Object.fromEntries(e.map(o=>[o.id,o])),r=t.querySelector("#session-stage");r.innerHTML=`
  ...
  `,r.querySelector("#back-setup").addEventListener("click",async()=>{fn(t,e,n,s)}),r.querySelector("#planner-start").addEventListener("click",async()=>{const o=new Date,l=o.getHours()*60+o.getMinutes(),d=a.filter(h=>h.taskId&&i[h.taskId]).sort((h,v)=>h.startTime-v.startTime).find(h=>h.startTime>=l),c=d?i[d.taskId]:e[0];if(!c)return;const u=n.contexts.find(h=>h.id===c.context),p=c.subjectId?s.find(h=>h.id===c.subjectId):null;mn(t,c,u,p,(d==null?void 0:d.durationMins)||n.defaultDuration,n)}),as(r,e,n,s,a,i)}function as(t,e,n,s,a,i){const r=t.querySelector("#planner-grid");if(!r)return;r.innerHTML="";const o=Array.from({length:14},(c,u)=>u+7),d=new Date().getHours();o.forEach(c=>{const u=a.find(k=>Math.floor(k.startTime/60)===c),p=u?i[u.taskId]:null,h=p?n.contexts.find(k=>k.id===p.context):null,v=p!=null&&p.subjectId?s.find(k=>k.id===p.subjectId):null,f=(v==null?void 0:v.color)||(h==null?void 0:h.color)||"#7F77DD",g=c===d,y=document.createElement("div");y.className="planner-row"+(g?" planner-now":""),y.innerHTML=`
    ...
    `;const m=y.querySelector(".planner-block");if(m){let k=null;m.addEventListener("click",async()=>{if(k){clearTimeout(k),k=null;return}const S=await $.tasks.get(+m.dataset.taskId),A=await te(),_=A.contexts.find(L=>L.id===(S==null?void 0:S.context)),T=S!=null&&S.subjectId?s.find(L=>L.id===S.subjectId):null;mn(Ms,S,_,T,u.durationMins||A.defaultDuration,A)});const x=()=>{k=setTimeout(async()=>{if(k=null,!confirm("Remove this block?"))return;await $.time_blocks.delete(u.id);const S=await $.time_blocks.where("date").equals(N()).toArray();as(t,e,n,s,S,Object.fromEntries(e.map(_=>[_.id,_])));const A=t.querySelector("#planner-total");A&&(A.textContent=is(S)+"h blocked")},500)},b=()=>{k&&(clearTimeout(k),k=null)};m.addEventListener("touchstart",x,{passive:!0}),m.addEventListener("touchend",b),m.addEventListener("mousedown",x),m.addEventListener("mouseup",b),m.addEventListener("mouseleave",b)}const w=y.querySelector(".planner-empty");w&&w.addEventListener("click",()=>$r(c,e,n,async()=>{const k=await $.time_blocks.where("date").equals(N()).toArray();as(t,e,n,s,k,Object.fromEntries(e.map(b=>[b.id,b])));const x=t.querySelector("#planner-total");x&&(x.textContent=is(k)+"h blocked")})),r.appendChild(y)})}async function $r(t,e,n,s){var l;const a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
    <div class="modal-card detail-modal">
      <div class="modal-drag-bar"></div>
      <div class="modal-header">
  ...
  `}function is(t){return(t.reduce((e,n)=>e+(n.durationMins||50),0)/60).toFixed(1)}function Wa(t){return t===0?"12am":t<12?`${t}am`:t===12?"12pm":`${t-12}pm`}async function Er(t){const e=new Date;let n=e.getFullYear(),s=e.getMonth();t.innerHTML=`
    <div class="view-header">
  ...
  `;const[a,i]=await Promise.all([te(),oe()]);async function r(){const o=new Date;o.setDate(o.getDate()-7);const l=new Date;l.setDate(l.getDate()+28),await tr(ue(o),ue(l)).catch(()=>{}),await Promise.all([Dr(i),Ya(n,s,i)])}t.querySelector("#cal-nav").addEventListener("click",async o=>{o.target.closest("#prev-month")&&(s--,s<0&&(s=11,n--),await r()),o.target.closest("#next-month")&&(s++,s>11&&(s=0,n++),await r()),o.target.closest("#today-btn")&&(n=e.getFullYear(),s=e.getMonth(),await r())}),t.querySelector("#cal-grid").addEventListener("click",async o=>{const l=o.target.closest(".cal-day[data-date]");l&&await rs(l.dataset.date,i)}),t.querySelector("#schedule-btn").addEventListener("click",()=>{const o=ue(e);Ja(o,i,r)}),await r()}async function Dr(t,e){const n=document.getElementById("week-summary");if(!n)return;const s=new Date,a=new Date(s);a.setDate(s.getDate()-(s.getDay()+6)%7);const i=new Date(a);i.setDate(a.getDate()+6);const r=ue(a),o=ue(i),[l,d]=await Promise.all([Ke(r,o),ws(r,o)]),c=l.reduce((m,w)=>m+(w.durationMins||0),0),u=l.length,p=d.length,h=new Map;l.forEach(m=>{m.subjectId&&h.set(m.subjectId,(h.get(m.subjectId)||0)+(m.durationMins||0))});const v=Array(7).fill(0);l.forEach(m=>{const k=(new Date(m.startedAt).getDay()+6)%7;v[k]+=m.durationMins||0});const f=Math.max(...v,1),g=["M","T","W","T","F","S","S"],y=(s.getDay()+6)%7;n.innerHTML=`
  ...
  `;let s="week";async function a(){Hr(),t.querySelector("#btn-week").classList.toggle("seg-active",s==="week"),t.querySelector("#btn-day").classList.toggle("seg-active",s==="day"),s==="week"?await Mr(e,n):await Ir(e,n)}t.querySelector("#btn-week").addEventListener("click",()=>{s="week",a()}),t.querySelector("#btn-day").addEventListener("click",()=>{s="day",a()}),t.querySelector("#open-review").addEventListener("click",()=>{ie(()=>Promise.resolve().then(()=>vn),void 0).then(i=>i.navigateTo("review"))}),a()}async function Mr(t,e){const{fromStr:n,toStr:s,monday:a,prevFromStr:i,prevToStr:r}=Kr();document.getElementById("period-label").textContent="Week of "+a.toLocaleDateString("en-GB",{day:"numeric",month:"short"});const[o,l,d,c]=await Promise.all([Ke(n,s),Ke(i,r),Aa(t.activeDays,t.dailyGoalHours*60,t.streakFreezeEnabled?t.streakGraceDays??1:0),$.focus_sessions.toArray()]),u=o.reduce((D,O)=>D+(O.durationMins||0),0),p=l.reduce((D,O)=>D+(O.durationMins||0),0),h=o.filter(D=>D.durationMins>0).map(D=>Math.max(0,100-Math.round((D.distractions||0)/D.durationMins*100*.5))),v=h.length?Math.round(h.reduce((D,O)=>D+O,0)/h.length):null,f=l.filter(D=>D.durationMins>0).map(D=>Math.max(0,100-Math.round((D.distractions||0)/D.durationMins*100*.5))),g=f.length?Math.round(f.reduce((D,O)=>D+O,0)/f.length):null,y=c.length?c.reduce((D,O)=>(O.durationMins||0)>(D.durationMins||0)?O:D,c[0]):null,m=y&&o.some(D=>D.id===y.id),w=p>0?Math.round((u-p)/p*100):null,k=l.length>0?o.length-l.length:null,x=Array(24).fill(0);o.forEach(D=>{x[new Date(D.startedAt).getHours()]+=D.durationMins||0});const b=x.indexOf(Math.max(...x.slice(6,22))),S=x[b]>0?At(b):"—",A=Array(24).fill(0);l.forEach(D=>{A[new Date(D.startedAt).getHours()]+=D.durationMins||0});const _=A.indexOf(Math.max(...A.slice(6,22))),T=Array(7).fill(0);o.forEach(D=>{const O=(new Date(D.startedAt).getDay()+6)%7;T[O]+=D.durationMins||0});const L=new Map;o.forEach(D=>{D.subjectId&&L.set(D.subjectId,(L.get(D.subjectId)||0)+(D.durationMins||0))});const H=new Map;l.forEach(D=>{D.subjectId&&H.set(D.subjectId,(H.get(D.subjectId)||0)+(D.durationMins||0))});const K={};o.forEach(D=>{const O=D.context||"other";K[O]=(K[O]||0)+(D.durationMins||0)});const C=Math.max(1,Object.values(K).reduce((D,O)=>D+O,0)),V=t.streakFreezeEnabled?t.streakGraceDays??1:0,Z=await Promise.all(e.map(async D=>{const{current:O,best:it}=await bs(D.id,D.dailyGoalMins,t.activeDays,V);return{...D,current:O,best:it}})),U=document.getElementById("insights-body");U.innerHTML=`

    <div class="metric-grid">
      ${Ee("Focus hours",Be(u),w!==null?w>0?`↑ ${w}% from last week`:w<0?`↓ ${Math.abs(w)}% from last week`:"Same as last week":p===0?"No data last week":"",w!==null&&w>0?"positive":w!==null&&w<0?"negative":"")}
        ...
        <div class="card" id="subj-card">
          ...
          ${a.map(i=>`
            <div class="subj-row" data-id="${i.id}">
              <button class="subj-icon-btn" data-id="${i.id}" style="background:${j(i.color)}22;color:${j(i.color)};border:1px solid ${j(i.color)}44">
                ${j(i.icon||"📚")}
              </button>
              <div class="subj-row-body">
                ...
                <div class="subj-row-meta">
                  <input type="color" class="subj-color-input ctx-color-input" value="${j(i.color)}" data-id="${i.id}" title="Colour">
  ...
  `).join("");const i=n.getBoundingClientRect();a.style.position="fixed",a.style.top=i.bottom+6+"px",a.style.left=i.left+"px",a.style.zIndex="500",document.body.appendChild(a),a.addEventListener("click",async o=>{const l=o.target.closest(".icon-picker-btn");l&&(await Qt(e,{icon:l.dataset.icon}),n.textContent=l.dataset.icon,a.remove())}),setTimeout(()=>{document.addEventListener("click",function o(l){!a.contains(l.target)&&l.target!==n&&(a.remove(),document.removeEventListener("click",o))})},50)}function Yr(t,e){function n(){t.innerHTML=`
      <div class="settings-section">
        ...
        <div class="card" id="ctx-card">
          ${e.contexts.map((a,i)=>`
            <div class="ctx-edit-row" data-i="${i}">
              <input class="ctx-color-input" type="color" value="${j(a.color)}" data-i="${i}" title="Colour">
  ...
  `,gn(t,e)}function Qr(t,e){const n=window._apexSyncStatus||{status:"idle",pending:0},s={idle:{text:"Not started yet",cls:""},syncing:{text:"Syncing…",cls:"sync-badge--syncing"},synced:{text:"Synced just now",cls:"sync-badge--ok"},offline:{text:`Offline — ${n.pending} change${n.pending!==1?"s":""} pending`,cls:"sync-badge--offline"},error:{text:`Sync error — ${n.pending} queued`,cls:"sync-badge--error"}},a=s[n.status]||s.idle;t.innerHTML=`
    <div class="settings-section">
  ...
  `,gn(t,e),ie(()=>Promise.resolve().then(()=>ze),void 0).then(async({getLastSyncTime:i})=>{const r=await i(),o=t.querySelector("#last-sync-time");o&&(o.textContent=r?new Date(r).toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",day:"numeric",month:"short"}):"Never")}).catch(()=>{})}function Xr(t,e){t.innerHTML=`
    <div class="settings-section">
...
Reply with only valid JSON, no markdown.`,l=await i(o,s.aiApiKey);if(!a)return;if(!l){a.innerHTML='<p class="empty-hint">AI review unavailable. Check your API key.</p>';return}let d={};try{const c=l.replace(/```json|```/g,"").trim();d=JSON.parse(c)}catch{a.innerHTML=`<p style="font-size:13px;color:var(--text-secondary);line-height:1.6">${j(l)}</p>`;return}a.innerHTML=`
    ...
    <div class="review-items">
      ${An("Strength",d.strength,"#1D9E75")}
      ${An("Improve",d.opportunity,"#D85A30")}
      ${An("Acknowledged",d.challenge,"#888780")}
    </div>
  `}function An(t,e,n){return e?`
    <div class="review-item">
      <span class="review-item-label" style="color:${n}">${t}</span>
      <p class="review-item-text">${j(e)}</p>
    </div>`:""}async function lo(){const{fromStr:t}=Ls(),e=await $.settings.get("reviewNote_"+t);return j((e==null?void 0:e.value)||"")}async function co(){const{toStr:t}=Ls(),e=await $.settings.get("intention_"+t);return j((e==null?void 0:e.value)||"")}function Ls(){const t=new Date,e=new Date(t);e.setDate(t.getDate()-(t.getDay()+6)%7),e.setHours(0,0,0,0);const n=new Date(e);return n.setDate(e.getDate()+6),n.setHours(23,59,59,999),{fromStr:e.toISOString().slice(0,10),toStr:t.toISOString().slice(0,10),monday:e,sunday:n}}const Xa=["inbox","focus","calendar","insights","settings","review"];let un="inbox";const Mn={inbox:pr,focus:br,calendar:Er,insights:Ar,settings:Gr,review:ro};function Za(){const t=location.hash.replace("#","");Xa.includes(t)&&(un=t),uo(),qt(un)}async function qt(t){var n;if(!Xa.includes(t))return;un=t,location.hash=t,document.querySelectorAll(".nav-item").forEach(s=>{s.classList.toggle("active",s.dataset.tab===t)});const e=document.getElementById("view");if(e){e.innerHTML="";try{await((n=Mn[t])==null?void 0:n.call(Mn,e))}catch(s){console.error(`[Apex Focus] Render error on ${t}:`,s),e.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("install-btn").addEventListener("click",async()=>{if(!pt)return;pt.prompt();const{outcome:e}=await pt.userChoice;pt=null,t.remove()}),document.getElementById("install-dismiss").addEventListener("click",()=>{sessionStorage.setItem("installDismissed","1"),t.remove()})}async function So(t){if(!t.aiMorningPrioritisation||!t.aiApiKey)return;const e=await $.settings.get("morningPromptDate");if((e==null?void 0:e.value)===N())return;const s=new Date().getHours();if(s<6||s>11)return;const a=await $.tasks.where("status").anyOf(["today","inbox"]).filter(c=>!c.completedAt).toArray();if(a.length===0)return;const{fromStr:i}=Do(),r=await Ke(i,N()),o=Ra(a,r),l=await Mt(o,t.aiApiKey);if(!l)return;let d=[];try{const c=l.replace(/```json|```/g,"").trim();d=JSON.parse(c)}catch{return}if(!(!Array.isArray(d)||d.length===0)){for(const c of d){const u=a.find(p=>p.title.toLowerCase().includes(c.toLowerCase().slice(0,20)));u&&u.status!=="today"&&await $.tasks.update(u.id,{status:"today"})}await $.settings.put({key:"morningPromptDate",value:N()}),await $.settings.put({key:"morningPromptResult",value:JSON.stringify(d)}),_o(d)}}function _o(t){const e=document.createElement("div");e.className="morning-card",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("morning-close").addEventListener("click",()=>e.remove()),document.getElementById("morning-start").addEventListener("click",()=>{e.remove(),qt("focus")}),setTimeout(()=>e.classList.add("morning-card--in"),50)}async function $o(){await ko("https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.1/chart.umd.js"),await $.open(),Za(),Pa().catch(()=>{}),Ca();const t=await te();t.accentColor&&document.documentElement.style.setProperty("--accent",t.accentColor);try{const n=new Date;n.setDate(n.getDate()-1);const s=As(n);await $.time_blocks.where("date").below(s).delete()}catch{}if(t.morningReminderEnabled&&await go()&&bo(t.morningReminderTime),window._apexPlayBeep=vo,window._apexNotify=ei,So(t).catch(()=>{}),new Date().getDay()===0){const n=await $.settings.get("lastReviewDate");(n==null?void 0:n.value)!==N()&&setTimeout(()=>Eo(),3e3)}}function Eo(){const t=document.createElement("div");t.className="morning-card",t.innerHTML=`
    <div class="morning-card-inner">
      <div class="morning-header">
  ...
  `,document.body.appendChild(t),document.getElementById("sunday-close").addEventListener("click",async()=>{await $.settings.put({key:"lastReviewDate",value:N()}),t.remove()}),document.getElementById("sunday-start").addEventListener("click",async()=>{await $.settings.put({key:"lastReviewDate",value:N()}),t.remove(),qt("review")}),setTimeout(()=>t.classList.add("morning-card--in"),50)}function Do(){const t=new Date,e=new Date(t);return e.setDate(t.getDate()-(t.getDay()+6)%7),{fromStr:As(e)}}$o().catch(t=>{document.getElementById("app").innerHTML=`
